 ...
 */
public class LiteRcpUiPlugin extends AbstractUIPlugin {
	 ...
	 * The plug-in ID
	 */
	public static final String PLUGIN_ID = "com.lembed.lite.studio.rcp.ui"; //$NON-NLS-1$
	...
	// The shared instance
	private static LiteRcpUiPlugin fPlugin;
	 ...
	 */
	public static LiteRcpUiPlugin getDefault() {
		return fPlugin;
	}

	/**
	 * Gets the tracing workspace root directory. By default it uses the user's home
	 * directory. This value can be overwritten by using the global TRACING_RCP_ROOT
