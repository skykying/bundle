...
public class TraceImportOperation extends WorkspaceModifyOperation {
    ...
    /**
     * Sets the skip archive extraction option. When set to true, archive files will
     * be imported directly without being detected or extracted.
     *
    ...
    protected void execute(IProgressMonitor monitor) throws CoreException, InvocationTargetException, InterruptedException {
        int importOptionFlags = ImportTraceWizardPage.OPTION_CREATE_LINKS_IN_WORKSPACE |
