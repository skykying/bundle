...
public class STCSourceNotFoundEditor extends CommonSourceNotFoundEditor {
     ...
     * @since 4.1
     */
    public final static String ID = "com.lembed.codeanalyzer.binutils.link2source.STCSourceNotFoundEditor"; //$NON-NLS-1$
    ...
    private void addSourceMappingToCommon(IPath missingPath, IPath newSourcePath) throws CoreException {
        ...
        try {
            ...
            IStatus status = new Status(IStatus.ERROR, BinUtilsPlugin.PLUGIN_ID, 0,
