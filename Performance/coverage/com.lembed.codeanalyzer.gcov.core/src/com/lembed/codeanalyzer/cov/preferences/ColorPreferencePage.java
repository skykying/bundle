...
public class ColorPreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
    ...
    public ColorPreferencePage() {
        super(Messages.ColorPreferencePage_Title, AbstractUIPlugin.imageDescriptorFromPlugin(CovPlugin.PLUGIN_ID, "icons/toggle.gif"), //$NON-NLS-1$
                FieldEditorPreferencePage.GRID);
        this.setPreferenceStore(CovPlugin.getDefault().getPreferenceStore());
