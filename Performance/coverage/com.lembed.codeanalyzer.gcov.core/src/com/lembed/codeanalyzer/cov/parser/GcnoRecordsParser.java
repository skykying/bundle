...
import com.lembed.codeanalyzer.cov.utils.BEDataInputStream;
import com.lembed.codeanalyzer.cov.utils.GcovStringReader;
import com.lembed.codeanalyzer.cov.utils.LEDataInputStream;
import com.lembed.codeanalyzer.cov.utils.MasksGenerator;
    ...
    public void parseData(DataInput stream) throws IOException, CoreException {
        ...
        if (magic == GCOV_NOTE_MAGIC) {
            ...
            if (magic == GCOV_NOTE_MAGIC) {
                ...
                Status status = new Status(IStatus.ERROR, CovPlugin.PLUGIN_ID, message);
