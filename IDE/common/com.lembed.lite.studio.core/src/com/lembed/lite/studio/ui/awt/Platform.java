...
public class Platform {
    ...
    private static boolean isLeopard() {
        ...
        return os.startsWith("mac") && values.length==2 && "10".equals(values[0]) && Integer.valueOf(values[1])>=5;
    }
    ...
    public static Composite createBasicComposite(
    		...
    		final Display display,
    		final SwingComponentConstructor swingComponent) {
        Composite composite = new Composite(container, SWT.EMBEDDED | SWT.NO_BACKGROUND | SWT.DOUBLE_BUFFERED);
