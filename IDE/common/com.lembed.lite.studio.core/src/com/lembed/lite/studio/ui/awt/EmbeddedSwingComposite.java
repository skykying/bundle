...
public abstract class EmbeddedSwingComposite extends Composite {
    ...
    public EmbeddedSwingComposite(Composite parent, int style) {
        super(parent, style | SWT.EMBEDDED | SWT.NO_BACKGROUND | SWT.DOUBLE_BUFFERED);
    ...
    private void handleSettingsChange() {
    	...
    	if (null != display && !isDisposed()) {
    		Font newFont = display.getSystemFont();
    		if (null != newFont && !newFont.equals(currentSystemFont)) { 
