...
public class GdbBackend extends GnuArmGdbBackend {
	...
	/**
	 * Overridden to use our own launch environment and to add the working directory
	 * to exec(), although it is anyway set in a separate step
	...
	/**
	 * Overridden to also try getProjectOsPath(), if getGDBWorkingDirectory() is not
	 * defined.
	 * 
	 * May return null.
	 */
