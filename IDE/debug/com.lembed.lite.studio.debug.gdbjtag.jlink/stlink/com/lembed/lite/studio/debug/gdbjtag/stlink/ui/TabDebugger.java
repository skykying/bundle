...
//	private Text fGdbServerConnectionAddress;
	...
	private void createGdbServerGroup(Composite parent) {
...

		{
			...
			label.setText(Messages.getString("DebuggerTab.deviceName_Label"));
			// $NON-NLS-1$
...
//			fGdbServerSwoPort.setVisible(false); // @2017.5.22
...

		{
			...
			fDoGdbServerAllocateSemihostingConsole.setText(Messages.getString("DebuggerTab.gdbServerAllocateSemihostingConsole_Label"));
			fDoGdbServerAllocateSemihostingConsole.setToolTipText(Messages.getString("DebuggerTab.gdbServerAllocateSemihostingConsole_ToolTipText"));
			gd = new GridData(GridData.FILL_HORIZONTAL);
...
//		});
	...
	private void createGdbPathGroup(Composite parent){
		...
		GridData gd = new GridData(GridData.FILL_HORIZONTAL);
		group.setLayoutData(gd);
		group.setText(Messages.getString("DebuggerTab.gdbServerPathGroup_Text"));
