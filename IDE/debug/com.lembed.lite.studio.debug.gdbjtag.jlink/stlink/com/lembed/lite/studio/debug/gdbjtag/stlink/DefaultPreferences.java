...
public class DefaultPreferences {
	...
	protected static final String GDB_SERVER_EXECUTABLE_DEFAULT = "${stlink_path}/${stlink_gdbserver}";
	...
	protected static final String CLIENT_COMMANDS_DEFAULT = "";
	...
	public static final int GDB_SERVER_GDB_PORT_NUMBER_DEFAULT = 4242;
	public static final int GDB_SERVER_SWO_PORT_NUMBER_DEFAULT = 4243;
	public static final int GDB_SERVER_TELNET_PORT_NUMBER_DEFAULT = 4244;
	...
	private static final String STLINK_INTRFACE_DEPRECATED = "interface.default";
	private static final String STLINK_ENABLE_SEMIHOSTING_DEPRECATED = "enableSemihosting.default";
	private static final String STLINK_ENABLE_SWO_DEPRECATED = "enableSwo.default";

	private static final String STLINK_GDBSERVER_DEPRECATED = "stlink_gdbserver.default";
	private static final String STLINK_PATH_DEPRECATED = "stlink_path.default";
	...
	public static String getExecutableName() {
		...
		if (value == null) {
			...
			if (value == null) {
				value = getString(STLINK_GDBSERVER_DEPRECATED, "");
			}
		}
	...
	public static String getInstallFolder() {
		...
		if (value == null) {
			...
			if (value == null) {
				value = getString(STLINK_PATH_DEPRECATED, "");
			}
		}
	...
	public static boolean getJLinkEnableSemihosting() {
		...
		try {
			if (getPreferences().nodeExists(PersistentPreferences.GDB_STLINK_ENABLE_SEMIHOSTING)) {
	...
	public static boolean getJLinkEnableSwo() {
		try {
			if (getPreferences().nodeExists(PersistentPreferences.GDB_STLINK_ENABLE_SWO)) {
