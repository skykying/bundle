	...
	protected void doSetValue(Object value) {
		...
		if (regvalue != -1) {
			...
			for (int i = bitsize - 1; i >= 0; i--) {
				...
				b[i].setText("-");
				if (element instanceof TreeRegister) {
					b[i].setText(String.valueOf(com.lembed.lite.studio.debug.peripheralregview.views.Utils.getBitFromValue(i,
				...
				if (element instanceof TreeField) {
					...
					// add tooltip
					b[i].setToolTipText("Bit " + (i + ((TreeField) element).getBitOffset()));
				}
