...
public class PersistentPreferences {
	...
	public static final String GDB_STLINK = "gdb.jlink.";

	public static final String GDB_STLINK_DO_INITIAL_RESET = GDB_STLINK + "doInitialReset";
	public static final String GDB_STLINK_INITIAL_RESET_TYPE = GDB_STLINK + "initialReset.type";
	public static final String GDB_STLINK_INITIAL_RESET_SPEED = GDB_STLINK + "initialReset.speed";

	public static final String GDB_STLINK_SPEED = GDB_STLINK + "speed";

	public static final String GDB_STLINK_ENABLE_FLASH_BREAKPOINTS = GDB_STLINK + "enableFlashBreakpoints";
	public static final String GDB_STLINK_ENABLE_SEMIHOSTING = GDB_STLINK + "enableSemihosting";
	public static final String GDB_STLINK_SEMIHOSTING_TELNET = GDB_STLINK + "semihosting.telnet";
	public static final String GDB_STLINK_SEMIHOSTING_CLIENT = GDB_STLINK + "semihosting.client";

	public static final String GDB_STLINK_ENABLE_SWO = GDB_STLINK + "enableSwo";

	public static final String GDB_STLINK_SWO_ENABLE_TARGET_CPU_FREQ = GDB_STLINK + "swoEnableTarget.cpuFreq";
	public static final String GDB_STLINK_SWO_ENABLE_TARGET_SWO_FREQ = GDB_STLINK + "swoEnableTarget.swoFreq";
	public static final String GDB_STLINK_SWO_ENABLE_TARGET_PORT_MASK = GDB_STLINK + "swoEnableTarget.portMask";

	public static final String GDB_STLINK_INIT_OTHER = GDB_STLINK + "init.other";

	// Run Commands
	public static final String GDB_STLINK_DO_DEBUG_IN_RAM = GDB_STLINK + "doDebugInRam";

	public static final String GDB_STLINK_DO_PRERUN_RESET = GDB_STLINK + "doPreRunReset";
	public static final String GDB_STLINK_PRERUN_RESET_TYPE = GDB_STLINK + "preRunReset.type";

	public static final String GDB_STLINK_PRERUN_OTHER = GDB_STLINK + "preRun.other";
	...
	public static final String STLINK_GDBSERVER_DEPRECATED = "stlink_gdbserver";
	public static final String STLINK_PATH_DEPRECATED = "stlink_path";
	...
	private static String getString(String id, String defaultValue) {
		...
		String value;
		value = Platform.getPreferencesService().getString(STlinkPlugin.PLUGIN_ID, id, null, null);
	...
	private static void putWorkspaceString(String id, String value) {
		...
		Preferences preferences = InstanceScope.INSTANCE.getNode(STlinkPlugin.PLUGIN_ID);
	...
	public static void flush() {
		...
		try {
			InstanceScope.INSTANCE.getNode(STlinkPlugin.PLUGIN_ID).flush();
