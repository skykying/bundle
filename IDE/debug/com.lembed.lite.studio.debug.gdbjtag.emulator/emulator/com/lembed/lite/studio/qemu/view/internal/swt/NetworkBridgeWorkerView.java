...
public class NetworkBridgeWorkerView extends DeviceViewWithFileChooser {
	...
	public NetworkBridgeWorkerView(EmulatorQemuMachineControl myfile, int position) {
		super(myfile, null);
	...
	private void buildMe(String optionString) {
		...
		for (String option : options) {
			if (option.startsWith("vlan=")) {
				...
				this.helper.setText(option.substring(option.indexOf("=") + 1));
			}
		}
	}
