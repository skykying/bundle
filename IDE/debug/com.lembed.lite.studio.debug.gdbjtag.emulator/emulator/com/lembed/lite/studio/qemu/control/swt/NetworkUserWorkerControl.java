...
import com.lembed.lite.studio.qemu.model.swt.NetworkUserWorkerModel;
...
public class NetworkUserWorkerControl implements BaseControl {
	...
	public NetworkUserWorkerControl(EmulatorQemuMachineControl myfile, NetworkWorkerModel mymodel, int position) {
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getActionCommand().equals("eraseButton")) {
			...
			this.mymodel.buildIt((String) this.myview.getVlan().getSelectedItem(),
					this.myview.getNameContents().getText(), this.myview.getNet().getText(),
					this.myview.getHost().getText(), this.myview.getRestrict().isSelected(),
					this.myview.getHostname().getText(), this.myview.getDhcpstart().getText(),
					this.myview.getDns().getText(), new ArrayList<String>(), this.myview.getTftp().getText(),
					this.myview.getBootfile().getText(), this.myview.getSmb().getText(),
					this.myview.getSmbserver().getText(), new ArrayList<String>(), new ArrayList<String>());
			...
			if (this.myview.getIsEnabled().isSelected()) {
				this.mymodel.buildIt((String) this.myview.getVlan().getSelectedItem(),
						...
						this.myview.getHost().getText(), this.myview.getRestrict().isSelected(),
						this.myview.getHostname().getText(), this.myview.getDhcpstart().getText(),
						this.myview.getDns().getText(), this.mydnssearchcontrol.getMyResults(),
						this.myview.getTftp().getText(), this.myview.getBootfile().getText(),
						this.myview.getSmb().getText(), this.myview.getSmbserver().getText(),
						this.myhostfwdcontrol.getMyResults(), this.myguestfwdcontrol.getMyResults());
			} else {
				if (this.myview.getVlan().getSelectedIndex() != 0) {
					this.myview.getVlan().setSelectedIndex(0);
				}
