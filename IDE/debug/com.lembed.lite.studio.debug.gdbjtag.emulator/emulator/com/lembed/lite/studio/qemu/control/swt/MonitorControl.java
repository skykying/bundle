	...
	public void actionPerformed(ActionEvent e) {
		if (e.getActionCommand().equals("eraseButton")) {
			...
			if (this.myview.getMonitor().getSelectedIndex() != 0) {
				this.mymodel
						.unsetOption(VMConfigurationModel.getTagsOptions()[OptionsEnumModel.MONITOROPTION.getValor()]);
				this.myview.getMonitor().setSelectedIndex(0);
			}

			if (this.myview.getQmp().getSelectedIndex() != 0) {
				this.myqmpmodel
						.unsetOption(VMConfigurationModel.getTagsOptions()[OptionsEnumModel.QMPOPTION.getValor()]);
			...
			if (this.myview.getMonitor().getSelectedIndex() != 0) {
				this.mymodel.setOption((String) this.myview.getMonitor().getSelectedItem());
			} else {
				this.mymodel
						.unsetOption(VMConfigurationModel.getTagsOptions()[OptionsEnumModel.MONITOROPTION.getValor()]);
			}
			...
			if (this.myview.getQmp().getSelectedIndex() != 0) {
				this.myqmpmodel.setOption((String) this.myview.getQmp().getSelectedItem());
			} else {
