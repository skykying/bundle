...
public class NetworkTapWorkerView extends DeviceViewWithFileChooser {
	...
	public NetworkTapWorkerView(EmulatorQemuMachineControl myfile, int position) {
		super(myfile, null);
	...
	private void buildMe(String optionString) {
		...
		for (String option : options) {
			if (option.startsWith("vlan=")) {
				...
				this.downscript.setText(option.substring(option.indexOf("=") + 1));
