...
import com.lembed.lite.studio.qemu.model.swt.NetworkTapWorkerModel;
...
public class NetworkTapWorkerControl implements BaseControl {
	...
	public NetworkTapWorkerControl(EmulatorQemuMachineControl myfile, NetworkWorkerModel mymodel, int position) {
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getActionCommand().equals("eraseButton")) {
			...
			this.mymodel.buildIt((String) this.myview.getVlan().getSelectedItem(),
					...
					this.myview.getScript().getText(), this.myview.getDownscript().getText(),
