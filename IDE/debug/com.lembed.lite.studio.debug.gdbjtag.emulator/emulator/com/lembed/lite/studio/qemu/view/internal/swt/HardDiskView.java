...
public class HardDiskView extends DeviceViewWithFileChooser {
	...
	public HardDiskView(String firstHardDiskOption, String secondHardDiskOption, String thirdHardDiskOption,
			String fourthHardDiskOption) {
		super(null);
		...
		this.firstHardDiskImagePathButton = new JButton("Set First HD Image Path!");

		this.firstPhysicalHardDiskDriveButton = new JButton("Set First Physical HD Drive (Windows)!");

		this.firstReadOnlyVirtualFATHardDiskPathButton = new JButton("Set First READ-ONLY Virtual FAT HD Path!");

		this.firstReadWriteVirtualFATHardDiskPathButton = new JButton("Set First READ-WRITE Virtual FAT HD Path!");

		this.firstLinuxPhysicalHardDiskDriveButton = new JButton("Set First Physical HD Drive (Linux)!");
		...
		this.secondHardDiskImagePathButton = new JButton("Set Second HD Image Path!");

		this.secondPhysicalHardDiskDriveButton = new JButton("Set Second Physical HD Drive (Windows)!");

		this.secondReadOnlyVirtualFATHardDiskPathButton = new JButton("Set Second READ-ONLY Virtual FAT HD Path!");

		this.secondReadWriteVirtualFATHardDiskPathButton = new JButton("Set Second READ-WRITE Virtual FAT HD Path!");

		this.secondLinuxPhysicalHardDiskDriveButton = new JButton("Set Second Physical HD Drive (Linux)!");
		...
		this.thirdHardDiskImagePathButton = new JButton("Set Third HD Image Path!");

		this.thirdPhysicalHardDiskDriveButton = new JButton("Set Third Physical HD Drive (Windows)!");

		this.thirdReadOnlyVirtualFATHardDiskPathButton = new JButton("Set Third READ-ONLY Virtual FAT HD Path!");

		this.thirdReadWriteVirtualFATHardDiskPathButton = new JButton("Set Third READ-WRITE Virtual FAT HD Path!");

		this.thirdLinuxPhysicalHardDiskDriveButton = new JButton("Set Third Physical HD Drive (Linux)!");
		...
		this.fourthHardDiskImagePathButton = new JButton("Set Fourth HD Image Path!");

		this.fourthPhysicalHardDiskDriveButton = new JButton("Set Fourth Physical HD Drive (Windows)!");

		this.fourthReadOnlyVirtualFATHardDiskPathButton = new JButton("Set Fourth READ-ONLY Virtual FAT HD Path!");

		this.fourthReadWriteVirtualFATHardDiskPathButton = new JButton("Set Fourth READ-WRITE Virtual FAT HD Path!");

		this.fourthLinuxPhysicalHardDiskDriveButton = new JButton("Set Fourth Physical HD Drive (Linux)!");
		...
		/*
		 * temp1 = new JLabel(""); temp2 = new JLabel("");
		 */
	...
	public void configureStandardMode() {
		this.firstHardDiskImagePathButton.setActionCommand("ChangeDiskImagePathButton");
		this.firstPhysicalHardDiskDriveButton.setActionCommand("SetFirstPhysicalHardDiskDriveButton");
		this.firstLinuxPhysicalHardDiskDriveButton.setActionCommand("SetFirstLinuxPhysicalHardDiskDriveButton");
		this.firstReadOnlyVirtualFATHardDiskPathButton.setActionCommand("SetFirstReadOnlyVirtualFATHardDiskPathButton");
		this.firstReadWriteVirtualFATHardDiskPathButton
				.setActionCommand("SetFirstReadWriteVirtualFATHardDiskPathButton");
		this.secondHardDiskImagePathButton.setActionCommand("ChangeSecondDiskImagePathButton");
		this.secondPhysicalHardDiskDriveButton.setActionCommand("SetSecondPhysicalHardDiskDriveButton");
		this.secondLinuxPhysicalHardDiskDriveButton.setActionCommand("SetSecondLinuxPhysicalHardDiskDriveButton");
		...
		this.thirdHardDiskImagePathButton.setActionCommand("ChangeThirdDiskImagePathButton");
		this.thirdPhysicalHardDiskDriveButton.setActionCommand("SetThirdPhysicalHardDiskDriveButton");
		this.thirdLinuxPhysicalHardDiskDriveButton.setActionCommand("SetThirdLinuxPhysicalHardDiskDriveButton");
		this.thirdReadOnlyVirtualFATHardDiskPathButton.setActionCommand("SetThirdReadOnlyVirtualFATHardDiskPathButton");
		this.thirdReadWriteVirtualFATHardDiskPathButton
				.setActionCommand("SetThirdReadWriteVirtualFATHardDiskPathButton");
		this.fourthHardDiskImagePathButton.setActionCommand("ChangeFourthDiskImagePathButton");
		this.fourthPhysicalHardDiskDriveButton.setActionCommand("SetFourthPhysicalHardDiskDriveButton");
		this.fourthLinuxPhysicalHardDiskDriveButton.setActionCommand("SetFourthLinuxPhysicalHardDiskDriveButton");
	...
	public void configureListener(ActionListener listener) {
		...
		this.firstReadOnlyVirtualFATHardDiskPathButton.addActionListener(listener);
		this.firstReadWriteVirtualFATHardDiskPathButton.addActionListener(listener);
		...
		this.secondReadOnlyVirtualFATHardDiskPathButton.addActionListener(listener);
		this.secondReadWriteVirtualFATHardDiskPathButton.addActionListener(listener);
		...
		this.thirdReadOnlyVirtualFATHardDiskPathButton.addActionListener(listener);
		this.thirdReadWriteVirtualFATHardDiskPathButton.addActionListener(listener);
		...
		this.fourthReadOnlyVirtualFATHardDiskPathButton.addActionListener(listener);
		this.fourthReadWriteVirtualFATHardDiskPathButton.addActionListener(listener);
