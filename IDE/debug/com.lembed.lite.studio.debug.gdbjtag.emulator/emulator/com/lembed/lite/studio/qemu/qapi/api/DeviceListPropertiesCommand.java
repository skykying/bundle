 ...
 * Autogenerated class.
 *
 * <pre>QApiCommandDescriptor{name=device-list-properties, returns=[ObjectPropertyInfo], data={typename=str}}</pre>
 */
// QApiCommandDescriptor{name=device-list-properties, returns=[ObjectPropertyInfo], data={typename=str}}
