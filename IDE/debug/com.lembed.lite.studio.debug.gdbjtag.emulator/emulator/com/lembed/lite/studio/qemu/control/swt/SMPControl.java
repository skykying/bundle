...
public class SMPControl implements BaseControl {
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getActionCommand().equals("eraseButton")) {
			...
			this.mymodel.buildIt((String) this.myview.getCpuNumbers().getSelectedItem(),
					(String) this.myview.getCoreNumbers().getSelectedItem(),
					(String) this.myview.getThreadNumbers().getSelectedItem(),
					(String) this.myview.getSocketNumbers().getSelectedItem(),
					(String) this.myview.getMaxCpuNumbers().getSelectedItem());
			this.myview.setVisible(false);
		}
	}
