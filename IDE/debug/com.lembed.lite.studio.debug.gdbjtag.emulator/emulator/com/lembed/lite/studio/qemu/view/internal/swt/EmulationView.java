...
public class EmulationView extends DeviceBaseView {
	...
	public boolean warns() {
		 ...
		 */
		int response = JOptionPane.showConfirmDialog(null, trueMessage, "Confirm stop Qemu", dialogButton);
