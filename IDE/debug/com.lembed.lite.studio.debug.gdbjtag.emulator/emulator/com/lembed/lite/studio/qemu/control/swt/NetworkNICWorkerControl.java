...
public class NetworkNICWorkerControl implements BaseControl {
	...
	public NetworkNICWorkerControl(EmulatorQemuMachineControl myfile, NetworkWorkerModel mymodel, int position) {
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getActionCommand().equals("eraseButton")) {
			...
			this.mymodel.buildIt((String) this.myview.getVlan().getSelectedItem(), this.myview.getMacaddr().getText(),
					(String) this.myview.getModel().getSelectedItem(), this.myview.getNameContents().getText(),
					this.myview.getAddr().getText(), (String) this.myview.getVectorsNumber().getSelectedItem());
			this.myview.setVisible(false);
		} else if (e.getActionCommand().equals("okButton")) {
			if (this.myview.getIsEnabled().isSelected()) {
				this.mymodel.buildIt((String) this.myview.getVlan().getSelectedItem(),
						this.myview.getMacaddr().getText(), (String) this.myview.getModel().getSelectedItem(),
						this.myview.getNameContents().getText(), this.myview.getAddr().getText(),
