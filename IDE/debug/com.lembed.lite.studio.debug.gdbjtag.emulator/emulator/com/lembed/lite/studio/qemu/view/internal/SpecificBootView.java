...
public class SpecificBootView extends JFileChooserView {
    ...
    public SpecificBootView(FileControl myfile) {
        ...
        if (myfile.getFilemodel().getKernelBootOption() != null) {
            if (!myfile.getFilemodel().getKernelBootOption().isEmpty()) {
                this.kernel.setText(myfile.getFilemodel().getKernelBootOption());
            }
        }
