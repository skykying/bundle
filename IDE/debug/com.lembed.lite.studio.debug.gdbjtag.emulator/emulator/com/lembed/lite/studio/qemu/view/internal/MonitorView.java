...
public class MonitorView extends JFrame {
    ...
    public MonitorView(FileControl myfile) {
        ...
        if (myfile.getFilemodel().getMonitorOption() != null) {
            this.monitor.setSelectedItem(
                    this.falseOptions.get(myfile.getFilemodel()
                            .getMonitorOption()));
        }

        if (myfile.getFilemodel().getQmpOption() != null) {
            this.qmp.setSelectedItem(
                    this.falseOptions.get(myfile.getFilemodel().getQmpOption())
            );
        }
