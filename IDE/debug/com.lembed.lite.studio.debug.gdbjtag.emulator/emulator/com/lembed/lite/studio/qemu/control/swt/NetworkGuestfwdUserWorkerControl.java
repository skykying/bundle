...
public class NetworkGuestfwdUserWorkerControl implements BaseControl {
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getActionCommand().equals("eraseButton")) {
			...
			this.myResults = this.mymodel.buildIt(this.myview.getGuestfwd().getText());
			this.myview.setVisible(false);
		} else if (e.getActionCommand().equals("add")) {
			if (!this.myview.getIpAddrServer().getText().isEmpty() || !this.myview.getPort().getText().isEmpty()
					|| !this.myview.getSecondOption().getText().isEmpty()) {
				this.myview.buildMe("tcp:" + this.myview.getIpAddrServer().getText() + ":"
						+ this.myview.getPort().getText() + "-" + this.myview.getSecondOption().getText());
			}
