...
public class VMCreationViewPart2 extends DeviceViewWithFileChooser {
	...
	public VMCreationViewPart2(String default_virtual_machines_path, String additionalPath) {
		super(null);
		...
		windowDescriptionLabel = new JLabel("Choose location for the new machine:");
		...
		this.basePath = default_virtual_machines_path + additionalPath;

		virtual_machine_path_chooser = new JButton("Choose a VM Directory!");
	...
	public void setChooseMachineName(String chooseMachineName) {
		...
		this.chooseVMPathField.setText(this.basePath + this.chooseMachineName);
	}
