...
public class NetworkHubportWorkerControl implements BaseControl {
	...
	public NetworkHubportWorkerControl(EmulatorQemuMachineControl myfile, NetworkWorkerModel mymodel, int position) {
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getActionCommand().equals("eraseButton")) {
			...
			this.mymodel.buildIt(this.myview.getId().getText(), this.myview.getHubid().getText());
