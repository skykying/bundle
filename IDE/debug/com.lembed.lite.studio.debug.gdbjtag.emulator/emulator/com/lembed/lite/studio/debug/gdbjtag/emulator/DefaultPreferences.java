...
public class DefaultPreferences {
	...
	public static final String SERVER_EXECUTABLE_DEFAULT = "${emulator_path}/${emulator_executable}";
	protected static final String CLIENT_EXECUTABLE_DEFAULT = "${cross_prefix}gdb${cross_suffix}";

	public static final String SERVER_EXECUTABLE_DEFAULT_NAME = "emulator-system-litestudio";
