 ...
 * Autogenerated class.
 *
 * <pre>QApiStructDescriptor{name=NetdevTapOptions, data={*ifname=str, *fd=str, *fds=str, *script=str, *downscript=str, *br=str, *helper=str, *sndbuf=size, *vnet_hdr=bool, *vhost=bool, *vhostfd=str, *vhostfds=str, *vhostforce=bool, *queues=uint32, *poll-us=uint32}, innerTypes=null, fields=null, base=null}</pre>
 */
// QApiStructDescriptor{name=NetdevTapOptions, data={*ifname=str, *fd=str, *fds=str, *script=str, *downscript=str, *br=str, *helper=str, *sndbuf=size, *vnet_hdr=bool, *vhost=bool, *vhostfd=str, *vhostfds=str, *vhostforce=bool, *queues=uint32, *poll-us=uint32}, innerTypes=null, fields=null, base=null}
...
public class NetdevTapOptions extends QApiType {
	...
	@JsonProperty("poll-us")
	@CheckForNull
	public java.lang.Long pollUs;
	...
	@Nonnull
	public NetdevTapOptions withBr(java.lang.String value) {
		this.br = value;
		return this;
	}
	...
	@Nonnull
	public NetdevTapOptions withPollUs(java.lang.Long value) {
		this.pollUs = value;
		return this;
	}
