...
public class TabDebugger extends AbstractLaunchConfigurationTab {
	...
	private static final String TAB_ID = EmulatorPlugin.PLUGIN_ID + ".ui.debuggertab";
	...
	public void initializeFrom(ILaunchConfiguration configuration) {
		...
		try {
			...
			// QEMU GDB server
			{
				...
				String boardName = LiteProjectAttributes.getCmsisBoardName(configuration);
				fSavedCmsisBoardName = boardName;
				String deviceName = LiteProjectAttributes.getCmsisDeviceName(configuration);
