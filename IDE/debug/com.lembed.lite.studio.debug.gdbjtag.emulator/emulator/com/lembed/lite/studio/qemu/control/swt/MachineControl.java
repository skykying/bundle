...
public class MachineControl implements BaseControl {
	...
	public LinkedList<DeviceBaseView> getViews() {
		...
		list.add(machineTypeView);
		list.add(machineOptionsView);
	...
	public void init() {
		...
		if (this.machineOptionsView.getLoaded() || this.machineTypeView.getLoaded()) {
			if (this.machineTypeView.getMachineTypes().getSelectedItem().toString().indexOf(":") != -1) {
				this.machineModel
						.buildIt(
								this.machineTypeView.getMachineTypes().getSelectedItem().toString()
										.substring(this.machineTypeView.getMachineTypes().getSelectedItem().toString()
												.indexOf(":") + 2),
								this.machineModel.buildAccel(
										(String) this.machineOptionsView.getFirstOption().getSelectedItem(),
										(String) this.machineOptionsView.getSecondOption().getSelectedItem(),
										(String) this.machineOptionsView.getThirdOption().getSelectedItem()),
								(String) this.machineOptionsView.getKernel_irqchip().getSelectedItem(),
								Double.parseDouble(
										this.machineOptionsView.getEditor().getTextField().getText().replace(",", ".")),
								(String) this.machineOptionsView.getDump_guest_core().getSelectedItem(),
								(String) this.machineOptionsView.getMem_merge().getSelectedItem());
			} else {
				this.machineModel.buildIt(
						this.machineTypeView.getMachineTypes().getSelectedItem().toString().toLowerCase(Locale.ENGLISH),
						this.machineModel.buildAccel(
								(String) this.machineOptionsView.getFirstOption().getSelectedItem(),
								(String) this.machineOptionsView.getSecondOption().getSelectedItem(),
								(String) this.machineOptionsView.getThirdOption().getSelectedItem()),
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getActionCommand().equals("eraseButton")) {
			...
			this.machineModel
					.unsetOption(VMConfigurationModel.getTagsOptions()[OptionsEnumModel.MACHINEOPTION.getValor()]);
			...
			if (this.machineTypeView.getMachineTypes().getSelectedItem().toString().indexOf(":") != -1) {
				...
				eQctl.getMachineModel()
						.setMachineType(this.machineTypeView.getMachineTypes().getSelectedItem().toString().substring(
								this.machineTypeView.getMachineTypes().getSelectedItem().toString().indexOf(":") + 2));
			} else {
				this.machineModel.buildIt(
						this.machineTypeView.getMachineTypes().getSelectedItem().toString().toLowerCase(Locale.ENGLISH),
						this.machineModel.buildAccel(
						...
						(String) this.machineOptionsView.getDump_guest_core().getSelectedItem(),
						(String) this.machineOptionsView.getMem_merge().getSelectedItem());
				eQctl.getMachineModel().setMachineType(this.machineTypeView.getMachineTypes().getSelectedItem()
			...
			eQctl.getMachineModel()
					.setMachineAccel1((String) this.machineOptionsView.getFirstOption().getSelectedItem());
			eQctl.getMachineModel()
					.setMachineAccel2((String) this.machineOptionsView.getSecondOption().getSelectedItem());
			eQctl.getMachineModel()
					.setMachineAccel3((String) this.machineOptionsView.getThirdOption().getSelectedItem());
			eQctl.getMachineModel()
					.setMachineKernel_irpchip((String) this.machineOptionsView.getKernel_irqchip().getSelectedItem());
			eQctl.getMachineModel()
					.setMachineKvm_shadow_mem(this.machineOptionsView.getEditor().getTextField().getText());
			eQctl.getMachineModel()
					.setMachineDump_guest_core((String) this.machineOptionsView.getDump_guest_core().getSelectedItem());
			eQctl.getMachineModel()
					.setMachineMem_merge((String) this.machineOptionsView.getMem_merge().getSelectedItem());
			this.machineOptionsView.setVisible(false);
		} else if (e.getActionCommand().equals("showOptionsButton")) {
			this.machineOptionsView.setVisible(true);
		} else if (e.getActionCommand().equals("firstOption") || e.getActionCommand().equals("secondOption")
