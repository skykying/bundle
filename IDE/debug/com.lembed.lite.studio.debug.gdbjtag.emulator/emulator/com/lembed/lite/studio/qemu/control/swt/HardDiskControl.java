...
public class HardDiskControl implements BaseControl {
	...
	public HardDiskControl(EmulationControl myemulation, EmulatorQemuMachineControl emc) {
		this.hardDiskView = new HardDiskView(emc.getMachineModel().getFirstHardDiskOption(),
				emc.getMachineModel().getSecondHardDiskOption(), emc.getMachineModel().getThirdHardDiskOption(),
				emc.getMachineModel().getFourthHardDiskOption());
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getActionCommand().equals("ChangeDiskImagePathButton")) {
			this.hardDiskView.setChoosertitle("Choose the first disk image path!");
		...
		} else if (e.getActionCommand().equals("SetFirstPhysicalHardDiskDriveButton")) {
		...
		} else if (e.getActionCommand().equals("SetFirstReadOnlyVirtualFATHardDiskPathButton")) {
			...
			if (this.hardDiskView.chooseDirectoryForDefaultVMPath()) {
				...
				this.hardDiskView
						.changesFirstHardDiskOptionField(this.convertFatReadOnly(this.hardDiskView.getChoice()));
			}
		} else if (e.getActionCommand().equals("SetFirstReadWriteVirtualFATHardDiskPathButton")) {
			...
			if (this.hardDiskView.chooseDirectoryForDefaultVMPath()) {
				...
				this.hardDiskView
						.changesFirstHardDiskOptionField(this.convertFatReadWrite(this.hardDiskView.getChoice()));
			}
		} else if (e.getActionCommand().equals("ChangeSecondDiskImagePathButton")) {
			this.hardDiskView.setChoosertitle("Choose the second disk image path!");
			if (this.hardDiskView.chooseFiles()) {
		...
		} else if (e.getActionCommand().equals("SetSecondPhysicalHardDiskDriveButton")) {
		...
		} else if (e.getActionCommand().equals("SetSecondReadOnlyVirtualFATHardDiskPathButton")) {
			...
			if (this.hardDiskView.chooseDirectoryForDefaultVMPath()) {
				...
				this.hardDiskView
						.changesSecondHardDiskOptionField(this.convertFatReadOnly(this.hardDiskView.getChoice()));
			}
		} else if (e.getActionCommand().equals("SetSecondReadWriteVirtualFATHardDiskPathButton")) {
			...
			if (this.hardDiskView.chooseDirectoryForDefaultVMPath()) {
				...
				this.hardDiskView
						.changesSecondHardDiskOptionField(this.convertFatReadWrite(this.hardDiskView.getChoice()));
			}
		} else if (e.getActionCommand().equals("ChangeThirdDiskImagePathButton")) {
			this.hardDiskView.setChoosertitle("Choose the third disk image path!");
			if (this.hardDiskView.chooseFiles()) {
		...
		} else if (e.getActionCommand().equals("SetThirdPhysicalHardDiskDriveButton")) {
		...
		} else if (e.getActionCommand().equals("SetThirdReadOnlyVirtualFATHardDiskPathButton")) {
			...
			if (this.hardDiskView.chooseDirectoryForDefaultVMPath()) {
				...
				this.hardDiskView
						.changesThirdHardDiskOptionField(this.convertFatReadOnly(this.hardDiskView.getChoice()));
			}
		} else if (e.getActionCommand().equals("SetThirdReadWriteVirtualFATHardDiskPathButton")) {
			...
			if (this.hardDiskView.chooseDirectoryForDefaultVMPath()) {
				...
				this.hardDiskView
						.changesThirdHardDiskOptionField(this.convertFatReadWrite(this.hardDiskView.getChoice()));
			}
		} else if (e.getActionCommand().equals("ChangeFourthDiskImagePathButton")) {
			this.hardDiskView.setChoosertitle("Choose the fourth disk image path!");
			if (this.hardDiskView.chooseFiles()) {
		...
		} else if (e.getActionCommand().equals("SetFourthPhysicalHardDiskDriveButton")) {
		...
		} else if (e.getActionCommand().equals("SetFourthReadOnlyVirtualFATHardDiskPathButton")) {
			...
			if (this.hardDiskView.chooseDirectoryForDefaultVMPath()) {
				...
				this.hardDiskView
						.changesFourthHardDiskOptionField(this.convertFatReadOnly(this.hardDiskView.getChoice()));
			}
		} else if (e.getActionCommand().equals("SetFourthReadWriteVirtualFATHardDiskPathButton")) {
			...
			if (this.hardDiskView.chooseDirectoryForDefaultVMPath()) {
				...
				this.hardDiskView
						.changesFourthHardDiskOptionField(this.convertFatReadWrite(this.hardDiskView.getChoice()));
			}
		} else if (e.getActionCommand().equals("okButtonHDI")) {
			if (!this.hardDiskView.getFirstHardDiskOption().equals(this.hardDiskModel.getFirstHardDiskOption())) {
				this.hardDiskModel.setFirstHardDiskOption(this.hardDiskView.getFirstHardDiskOption());
				this.hardDiskView.changesFirstHardDiskOptionField(this.hardDiskView.getFirstHardDiskOption());
			}

			if (!this.hardDiskView.getSecondHardDiskOption().equals(this.hardDiskModel.getSecondHardDiskOption())) {
				this.hardDiskModel.setSecondHardDiskOption(this.hardDiskView.getSecondHardDiskOption());
				this.hardDiskView.changesSecondHardDiskOptionField(this.hardDiskView.getSecondHardDiskOption());
			}

			if (!this.hardDiskView.getThirdHardDiskOption().equals(this.hardDiskModel.getThirdHardDiskOption())) {
				this.hardDiskModel.setThirdHardDiskOption(this.hardDiskView.getThirdHardDiskOption());
				this.hardDiskView.changesThirdHardDiskOptionField(this.hardDiskView.getThirdHardDiskOption());
			}

			if (!this.hardDiskView.getFourthHardDiskOption().equals(this.hardDiskModel.getFourthHardDiskOption())) {
				this.hardDiskModel.setFourthHardDiskOption(this.hardDiskView.getFourthHardDiskOption());
				this.hardDiskView.changesFourthHardDiskOptionField(this.hardDiskView.getFourthHardDiskOption());
			}
	...
	public void setPhysicalDriveChoice(int position, String choice) {
		if (position == 1) {
			...
			} else if (this.hardDiskView.getFirstHardDiskOption()
			...
			} else if (this.hardDiskView.getSecondHardDiskOption()
					.startsWith("\\" + "\\" + "." + "\\" + "PhysicalDrive")) {
				this.hardDiskModel.setSecondHardDiskOption("");
				this.hardDiskView.changesSecondHardDiskOptionField("");
			}
			...
			} else if (this.hardDiskView.getThirdHardDiskOption()
					.startsWith("\\" + "\\" + "." + "\\" + "PhysicalDrive")) {
				this.hardDiskModel.setThirdHardDiskOption("");
				this.hardDiskView.changesThirdHardDiskOptionField("");
			}
			...
			} else if (this.hardDiskView.getFourthHardDiskOption()
					.startsWith("\\" + "\\" + "." + "\\" + "PhysicalDrive")) {
				this.hardDiskModel.setFourthHardDiskOption("");
				this.hardDiskView.changesFourthHardDiskOptionField("");
			}
