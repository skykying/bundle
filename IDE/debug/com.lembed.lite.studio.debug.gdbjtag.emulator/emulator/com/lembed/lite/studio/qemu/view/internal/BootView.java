...
public class BootView extends JFileChooserView {
    ...
    public BootView(FileControl myfile) {
        ...
        onceLabel = new JLabel("Select the boot order device only on the first startup:");
        ...
        rebootTimeout = new JCheckBox("Set the reboot timeout (ms) (-1, for not reboot!):");
        ...
        if (myfile.getFilemodel().getBootOrder1() != null) {
            for (int i = 0; i < bootDevices.length; i++) {
                if (!bootDevices[i].isEmpty()) {
                    if (myfile.getFilemodel().getBootOrder1().equals(bootDevices[i].substring(0, 1))) {
        ...
        if (myfile.getFilemodel().getBootOrder2() != null) {
            for (int i = 0; i < bootDevices.length; i++) {
                if (!bootDevices[i].isEmpty()) {
                    if (myfile.getFilemodel().getBootOrder2().equals(bootDevices[i].substring(0, 1))) {
        ...
        if (myfile.getFilemodel().getBootOrder3() != null) {
            for (int i = 0; i < bootDevices.length; i++) {
                if (!bootDevices[i].isEmpty()) {
                    if (myfile.getFilemodel().getBootOrder3().equals(bootDevices[i].substring(0, 1))) {
        ...
        if (myfile.getFilemodel().getBootOnce1() != null) {
            for (int i = 0; i < bootDevices.length; i++) {
                if (!bootDevices[i].isEmpty()) {
                    if (myfile.getFilemodel().getBootOnce1()
        ...
        if (myfile.getFilemodel().getBootOnce2() != null) {
            for (int i = 0; i < bootDevices.length; i++) {
                if (!bootDevices[i].isEmpty()) {
                    if (myfile.getFilemodel().getBootOnce2()
                            .equals(bootDevices[i].substring(0, 1))) {
        ...
        if (myfile.getFilemodel().getBootOnce3() != null) {
            for (int i = 0; i < bootDevices.length; i++) {
                if (!bootDevices[i].isEmpty()) {
                    if (myfile.getFilemodel().getBootOnce3()
                            .equals(bootDevices[i].substring(0, 1))) {
        ...
        if (myfile.getFilemodel().getBootMenu() != null) {
            this.menu.setSelectedItem(myfile.getFilemodel().getBootMenu());
        }

        if (myfile.getFilemodel().getBootSplash() != null) {
            this.splashName.setText(myfile.getFilemodel().getBootSplash());
        }

        if (myfile.getFilemodel().getBootSplashTime() != null) {
            this.splashTime.setSelected(true);
            this.editor1.getTextField().setText(myfile.getFilemodel().getBootSplashTime());
        }

        if (myfile.getFilemodel().getBootRebootTimeout() != null) {
            this.rebootTimeout.setSelected(true);
            this.editor2.getTextField().setText(myfile.getFilemodel().getBootRebootTimeout());
        }

        if (myfile.getFilemodel().getBootStrict() != null) {
            this.strict.setSelectedItem(myfile.getFilemodel().getBootStrict());
        }
