...
public class EmulationControl {
    ...
    public EmulationControl(JQemuView view) {
        ...
        this.emulationModel = new EmulationModel(this.emulationView, view);
    }
    ...
    public boolean stops(int position) {
        if (this.emulationModel.getNumberOfProcesses() > position) {
            if (this.emulationModel.getProcessesControl(position) != null) {
                if (this.emulationModel.getProcessesControl(position).getMyModel()
                        .getMainThread().isAlive()) {
                    this.emulationModel.getProcessesControl(position).getMyModel()
            ...
            if (this.emulationModel.isRunning(this.emulationModel.getProcesses(i))) {
                if (this.emulationModel.getProcessesControl(i) != null) {
                    result.append("The emulation process output of the '")
                            .append(this.emulationModel.getProcessesControl(i)
                                    .getMachineName()).append("' VM is:\n");
                    result.append(this.emulationModel.getProcessesControl(i)
                            .getMyModel().getOutputs().getText());
                    if (result.toString().equals(
                            "The emulation process output of the '"
                            + this.emulationModel.getProcessesControl(i)
