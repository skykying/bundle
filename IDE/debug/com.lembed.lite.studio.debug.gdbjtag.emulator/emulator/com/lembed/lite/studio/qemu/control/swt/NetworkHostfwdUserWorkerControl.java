...
public class NetworkHostfwdUserWorkerControl implements BaseControl {
	...
	public NetworkHostfwdUserWorkerControl(EmulatorQemuMachineControl myfile, int position) {
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getActionCommand().equals("eraseButton")) {
			...
			this.myResults = this.mymodel.buildIt(this.myview.getHostfwd().getText());
			this.myview.setVisible(false);
		} else if (e.getActionCommand().equals("add")) {
			if (!this.myview.getHostaddr().getText().isEmpty() || !this.myview.getHostport().getText().isEmpty()
					|| !this.myview.getGuestaddr().getText().isEmpty()
					|| !this.myview.getGuestport().getText().isEmpty()) {
				this.myview.buildMe(
						this.myview.getConnectionType().getSelectedItem().toString().toLowerCase(Locale.ENGLISH) + ":"
								+ this.myview.getHostaddr().getText() + ":" + this.myview.getHostport().getText() + "-"
								+ this.myview.getGuestaddr().getText() + ":" + this.myview.getGuestport().getText());
			}
