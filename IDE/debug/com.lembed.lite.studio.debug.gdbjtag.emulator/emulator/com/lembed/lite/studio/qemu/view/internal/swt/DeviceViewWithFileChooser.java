...
public abstract class DeviceViewWithFileChooser extends DeviceBaseView {
	...
	public DeviceViewWithFileChooser(JPanel jpanel) {
		super();
		this.jpanel = jpanel;
		this.choice = "";
	...
	public boolean chooseFile() {
		...
		if (this.getChooser().showOpenDialog(this.jpanel) == JFileChooser.APPROVE_OPTION) {
	...
	public boolean chooseConfigurationFileToBeSaved() {
		...
		this.getChooser().setAcceptAllFileFilterUsed(false);
		if (this.getChooser().showSaveDialog(this.jpanel) == JFileChooser.APPROVE_OPTION) {
	...
	class DirectoryFileFilter extends javax.swing.filechooser.FileFilter {
		...
		public boolean accept(File f) {
			return f.getName().toLowerCase(Locale.ENGLISH).endsWith(fileExtension) || f.isDirectory();
		}
	...
	static class FilesFileFilter extends javax.swing.filechooser.FileFilter {
		...
		public boolean accept(File f) {
			return f.getName().toLowerCase(Locale.ENGLISH).endsWith(".img")
					...
					|| f.getName().toLowerCase(Locale.ENGLISH).endsWith(".parallels") || f.isDirectory();
		}
	...
	static class CDROMImageFileFilter extends javax.swing.filechooser.FileFilter {
		...
		public boolean accept(File f) {
			return f.getName().toLowerCase(Locale.ENGLISH).endsWith(".img")
					|| f.getName().toLowerCase(Locale.ENGLISH).endsWith(".iso") || f.isDirectory();
		}
	...
	static class SplashPictureFileFilter extends javax.swing.filechooser.FileFilter {
		...
		public boolean accept(File f) {
			return f.getName().toLowerCase(Locale.ENGLISH).endsWith(".jpeg")
					...
					|| f.getName().toLowerCase(Locale.ENGLISH).endsWith(".dib") || f.isDirectory();
		}
