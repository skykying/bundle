...
import com.lembed.lite.studio.qemu.model.swt.NetworkTCPSocketWorkerModel;
...
public class NetworkTCPSocketWorkerControl implements BaseControl {
	...
	public NetworkTCPSocketWorkerControl(EmulatorQemuMachineControl myfile, NetworkWorkerModel mymodel, int position) {
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getActionCommand().equals("eraseButton")) {
			...
			this.mymodel.buildIt((String) this.myview.getVlan().getSelectedItem(),
					...
					this.myview.getHostListen().getText(), this.myview.getPortListen().getText(),
					this.myview.getHostConnect().getText(), this.myview.getPortConnect().getText());
