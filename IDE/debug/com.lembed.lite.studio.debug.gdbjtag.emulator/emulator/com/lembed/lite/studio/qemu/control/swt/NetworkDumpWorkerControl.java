...
public class NetworkDumpWorkerControl implements BaseControl {
	...
	public NetworkDumpWorkerControl(EmulatorQemuMachineControl myfile, NetworkWorkerModel nmodel, int position) {
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getActionCommand().equals("eraseButton")) {
			...
			mymodel.buildIt((String) myview.getVlan().getSelectedItem(), myview.getFile().getText(),
