...
public class MachineOptionsView extends JFrame {
    ...
    public MachineOptionsView(FileControl myfile) {
        ...
        if (myfile.getFilemodel().getMachineAccel1() != null) {
            this.firstOption.setSelectedItem(myfile.getFilemodel().getMachineAccel1());
            this.loaded = true;
        }
        if (myfile.getFilemodel().getMachineAccel2() != null) {
            this.secondOption.setSelectedItem(myfile.getFilemodel().getMachineAccel2());
            this.loaded = true;
        }
        if (myfile.getFilemodel().getMachineAccel3() != null) {
            this.thirdOption.setSelectedItem(myfile.getFilemodel().getMachineAccel3());
            this.loaded = true;
        }
        if (myfile.getFilemodel().getMachineKernel_irpchip() != null) {
            this.kernel_irqchip.setSelectedItem(myfile.getFilemodel().getMachineKernel_irpchip());
            this.loaded = true;
        }
        if (myfile.getFilemodel().getMachineKvm_shadow_mem() != null) {
            this.editor.getTextField().setText(myfile.getFilemodel().getMachineKvm_shadow_mem());
            this.loaded = true;
        }
        if (myfile.getFilemodel().getMachineDump_guest_core() != null) {
            this.dump_guest_core.setSelectedItem(myfile.getFilemodel().getMachineDump_guest_core());
            this.loaded = true;
        }
        if (myfile.getFilemodel().getMachineMem_merge() != null) {
            this.mem_merge.setSelectedItem(myfile.getFilemodel().getMachineMem_merge());
            this.loaded = true;
        }
