...
import com.lembed.lite.studio.qemu.model.HardDiskModel;
import com.lembed.lite.studio.qemu.view.internal.HardDiskView;
...
public class HardDiskControl implements ActionListener {
    ...
    public HardDiskControl(EmulationControl myemulation, FileControl myfile) {
        this.myview = new HardDiskView(myfile.getFilemodel().getFirstHardDiskOption(),
                myfile.getFilemodel().getSecondHardDiskOption(), myfile
                .getFilemodel().getThirdHardDiskOption(), myfile
