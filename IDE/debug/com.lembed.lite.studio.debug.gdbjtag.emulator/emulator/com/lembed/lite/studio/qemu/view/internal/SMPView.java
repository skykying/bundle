...
public class SMPView extends JFrame {
    ...
    public SMPView(FileControl myfile) {
        ...
        if (myfile.getFilemodel().getSmpCpusNumber() != null) {
            this.getCpuNumbers().setSelectedItem(
                    myfile.getFilemodel().getSmpCpusNumber());
        }

        if (myfile.getFilemodel().getSmpCoresNumber() != null) {
            this.getCoreNumbers().setSelectedItem(
                    myfile.getFilemodel().getSmpCoresNumber());
        }

        if (myfile.getFilemodel().getSmpThreadsNumber() != null) {
            this.getThreadNumbers().setSelectedItem(
                    myfile.getFilemodel().getSmpThreadsNumber());
        }

        if (myfile.getFilemodel().getSmpSocketsNumber() != null) {
            this.getSocketNumbers().setSelectedItem(
                    myfile.getFilemodel().getSmpSocketsNumber());
        }

        if (myfile.getFilemodel().getSmpCpusMaxNumber() != null) {
            this.getMaxCpuNumbers().setSelectedItem(
                    myfile.getFilemodel().getSmpCpusMaxNumber());
        }
