...
public class MemoryView extends JFileChooserView {
    ...
    public MemoryView(FileControl myfile) {
        ...
        if (myfile.getFilemodel().getMemPathOption() != null) {
            if (!myfile.getFilemodel().getMemPathOption().isEmpty()) {
                this.memoryPath.setText(myfile.getFilemodel().getMemPathOption());
            }
        }

        if (myfile.getFilemodel().getMemPreallocOption() != null) {
            if (!myfile.getFilemodel().getMemPreallocOption().isEmpty()) {
                if (myfile.getFilemodel().getMemPreallocOption().equals("true")) {
