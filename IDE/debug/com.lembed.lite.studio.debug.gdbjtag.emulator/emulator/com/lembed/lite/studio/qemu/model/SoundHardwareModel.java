...
public class SoundHardwareModel extends OptionsControl {
    ...
    public SoundHardwareModel(EmulationControl myemulation, FileControl myfile) {
        ...
        if (this.myfile.getFilemodel().getSoundHardwareOption() != null) {
            this.setOption(falseOptions.get(this.myfile.getFilemodel().getSoundHardwareOption()));
        }
    ...
    public void unsetOption(String option) {
        ...
        this.myfile.getFilemodel().setSoundHardwareOption("");
    }
