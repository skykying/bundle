...
public class ConfigurationControl implements BaseControl {
    ...
    public ConfigurationControl(LastUsedFolderModel myLastUsedFolderModel,
        ...
        this.fileControl = new EmulatorQemuMachineControl(this.configurationView.getWindowContent(), null);
        ...
        if (Model.isValidString(this.lastUsedFileModel.getLastUsedFile(
            ...
            if (Model.isValidString(this.lastUsedFolderModel.getLastUsedFolder(
                ...
                this.fileControl.getMachineModel().readConfigurationFromXML(
                ...
                this.configurationModel.setDefault_virtual_machines_path(this.fileControl.getMachineModel().getDefaultVMPath());
            ...
            if (do_my_view_invisible) {
                ...
                if (this.configurationView.getJavaQemu_configuration_file_path() != null) {
                    this.fileControl.getMachineModel().setConfiguration(
                            ...
                            this.configurationView.getQemu_img_executable_path_choice(),
                            this.configurationView.getBios_vga_bios_keymaps_path_choice());
                    this.fileControl.getMachineModel().saveConfigurationToXML(
