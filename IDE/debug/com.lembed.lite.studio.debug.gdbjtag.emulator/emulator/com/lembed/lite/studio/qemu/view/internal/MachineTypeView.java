...
public class MachineTypeView extends JFrame {
    ...
    public MachineTypeView(FileControl myfile) {
        ...
        if (myfile.getFilemodel().getMachineType() != null) {
            if (myfile.getFilemodel().getMachineType().equals("")) {
                this.machineTypes.setSelectedItem(myfile.getFilemodel()
                        .getMachineType());
            } else if (myfile.getFilemodel().getMachineType().equals("q35")) {
                this.machineTypes.setSelectedItem("Standard ACPI PCI Based PC: q35");
            } else if (myfile.getFilemodel().getMachineType().equals("pc-q35-1.6")) {
                this.machineTypes.setSelectedItem("Standard ACPI PCI Based PC: pc-q35-1.6");
            } else if (myfile.getFilemodel().getMachineType().equals("pc-q35-1.5")) {
                this.machineTypes.setSelectedItem("Standard ACPI PCI Based PC: pc-q35-1.5");
            } else if (myfile.getFilemodel().getMachineType().equals("pc-q35-1.4")) {
                this.machineTypes.setSelectedItem("Standard ACPI PCI Based PC: pc-q35-1.4");
            } else if (myfile.getFilemodel().getMachineType().equals("pc")) {
                this.machineTypes.setSelectedItem("Standard ACPI PCI Based PC: pc");
            } else if (myfile.getFilemodel().getMachineType()
