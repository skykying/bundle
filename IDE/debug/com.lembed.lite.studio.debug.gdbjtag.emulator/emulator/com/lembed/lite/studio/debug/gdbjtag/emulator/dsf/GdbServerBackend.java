...
public class GdbServerBackend extends GnuArmGdbServerBackend {
	...
	public void initialize(final RequestMonitor rm) {
		...
		try {
			...
			rm.setStatus(new Status(IStatus.ERROR, EmulatorPlugin.PLUGIN_ID, -1, "Cannot get configuration", e)); //$NON-NLS-1$
			rm.done();
			return;
		}
	...
	protected BundleContext getBundleContext() {
		return EmulatorPlugin.getInstance().getBundle().getBundleContext();
	}
