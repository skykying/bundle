...
package com.lembed.lite.studio.debug.gdbjtag.ui;
...
public class Messages extends NLS {
	...
	private static final String MESSAGES = GdbActivator.PLUGIN_ID + ".ui.messages"; //$NON-NLS-1$
	...
	static {
		// Initialize above static strings
