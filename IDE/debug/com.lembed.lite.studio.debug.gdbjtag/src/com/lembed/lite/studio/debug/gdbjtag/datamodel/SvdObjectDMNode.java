...
public class SvdObjectDMNode {
	...
	/**
	 * Instantiates a new svd object DM node.
	 *
	 * @param node the node
	 */
	...
	public void dispose() {
		...
		if (fNode == null) {
			// GdbActivator.log("dispose() " + getClass().getSimpleName()
			// + " already disposed");
			return;
		}
	...
	public String getName() {
		return fNode.getProperty("name"); //$NON-NLS-1$
	}
	...
	public boolean isDerived() {
		return fNode.hasProperty("derivedFrom"); //$NON-NLS-1$
	}
	...
	public String getPropertyWithDerived(String name) {
		return getPropertyWithDerived(name, ""); //$NON-NLS-1$
	}
	...
	public String getPropertyWithDerivedWithParent(String name) {
		return getPropertyWithDerivedWithParent(name, ""); //$NON-NLS-1$
	}
