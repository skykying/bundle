...
public class PeripheralsColumnPresentation implements IColumnPresentation2 {
	 ...
	 */
	public static final String ID = GdbActivator.PLUGIN_ID + ".PERIPHERALS_COLUMN_PRESENTATION_ID"; //$NON-NLS-1$

	/** The Constant COLUMN_PERIPHERAL_ID. */
	public static final String COLUMN_PERIPHERAL_ID = "column.peripheral"; //$NON-NLS-1$
	
	/** The Constant COLUMN_ADDRESS_ID. */
	public static final String COLUMN_ADDRESS_ID = "column.address"; //$NON-NLS-1$
	
	/** The Constant COLUMN_DESCRIPTION_ID. */
	public static final String COLUMN_DESCRIPTION_ID = "column.description"; //$NON-NLS-1$
