...
/**
 * The Class PeripheralEditingSupport.
 */
public class PeripheralEditingSupport extends EditingSupport {
	...
	/**
	 * Instantiates a new peripheral editing support.
	 *
	 ...
	 */
	private static Object getValueForCellEditor(PeripheralRegisterVMNode peripheralRegister) {
	...
	protected void setValue(Object element, Object value) {
		...
		if ((element instanceof PeripheralRegisterFieldVMNode)) {
			...
			if (value instanceof String) {
				...
				if (((Integer) value).intValue() != -1 || str.indexOf(":") >= 0) { //$NON-NLS-1$
