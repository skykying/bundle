...
/**
 * The Class PeripheralFilterDialog.
 */
public class PeripheralFilterDialog extends TitleAreaDialog {
	...
	/**
	 * Instantiates a new peripheral filter dialog.
	 *
	...
	public void create() {
		super.create();
		setTitle("Filter"); //$NON-NLS-1$
		setMessage("Hide register/fields not containing the filter string", IMessageProvider.NONE); //$NON-NLS-1$
	}
	...
	protected Control createDialogArea(Composite parent) {
		...
		lbtFirstName.setText("Filter:"); //$NON-NLS-1$
