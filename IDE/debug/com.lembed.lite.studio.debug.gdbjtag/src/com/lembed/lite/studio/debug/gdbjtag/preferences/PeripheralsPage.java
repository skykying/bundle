...
import com.lembed.lite.studio.core.preferences.ThemeColorFieldEditor;
...
public class PeripheralsPage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
	...
	/** The Constant ID. */
	public static final String ID = "com.lembed.lite.studio.debug.gdbjtag.preferencePage.peripherals"; //$NON-NLS-1$

	// ------------------------------------------------------------------------

	/**
	 * Instantiates a new peripherals page.
	 */
	public PeripheralsPage() {
		super(GRID);

		// Explicit use of the workspace storage.
		setPreferenceStore(new ScopedPreferenceStore(InstanceScope.INSTANCE, GdbActivator.PLUGIN_ID));
	...
	public void init(IWorkbench workbench) {
		...
		GdbActivator.log("PeripheralsPage.init()"); //$NON-NLS-1$
	}
