...
import com.lembed.lite.studio.templates.processor.Activator;
...
public class SetPropertyToPluginResource extends ProcessRunner {
	...
	public void process(TemplateCore template, ProcessArgument[] args,	String processId, IProgressMonitor monitor)	throws ProcessFailureException {
		...
		//TODO args parser and exceptrion handler
		...
		if (url == null) {
			String msg = "Bundle resource not found " + bundle + " " + relativePath;//$NON-NLS-1$
			throw new ProcessFailureException(getProcessMessage(processId, IStatus.ERROR, msg)); //$NON-NLS-1$
		}
