...
public abstract class AbstractSTTreeViewer extends AbstractSTViewer {
    ...
    /**
     * Instantiates a new abstract ST tree viewer.
     *
     ...
     * @return Tree
     */
    private static Tree createTree(Composite parent, int style) {
    ...
    /**
     * @see com.lembed.lite.studio.dataviewers.abstractviewers.AbstractSTViewer#getColumns()
     * @since 5.0
     */
    @Override
