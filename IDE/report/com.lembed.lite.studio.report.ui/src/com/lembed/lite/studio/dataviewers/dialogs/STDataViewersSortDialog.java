...
import com.lembed.lite.studio.dataviewers.abstractviewers.STDataViewersComparator;
...
public class STDataViewersSortDialog extends TrayDialog {
        ...
        for (int i = 0; i < priorityCombos.length; i++) {
            ...
            if (i < priorityCombos.length - 1) {
                priorityCombos[i].addSelectionListener(new SelectionAdapter() {
                    ...
                    private void computeSelectionItems(int indexIn, List<String> allItems) {
                        // if not after the last
                        if (indexIn < priorityCombos.length) {
                            // target combo
                            Combo priorityCombo = priorityCombos[indexIn];
                            ...
                            computeSelectionItems(indexIn + 1, allItems);
                        }
                    }
                });
            } else {
     ...
     * @return String
     */
    private static String getDescendingText(int index) {
        switch (index) {
        case 1:
     ...
     * @return String
     */
    private static String getAscendingText(int index) {
        switch (index) {
        case 1:
