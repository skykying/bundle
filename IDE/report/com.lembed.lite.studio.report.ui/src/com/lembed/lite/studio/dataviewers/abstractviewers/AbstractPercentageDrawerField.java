...
import com.lembed.lite.studio.dataviewers.listeners.ISpecialDrawerListener;
...
public abstract class AbstractPercentageDrawerField extends AbstractSTDataViewersField implements
    ...
    public String getValue(Object obj) {
        return getPercentage(obj) + ""; //$NON-NLS-1$
    }
    ...
    /**
     * Checks if is setted number format.
     *
     * @return true, if is setted number format
     */
