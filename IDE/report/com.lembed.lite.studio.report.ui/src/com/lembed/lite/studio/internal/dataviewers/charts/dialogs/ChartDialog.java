 ...
 *******************************************************************************/
package com.lembed.lite.studio.internal.dataviewers.charts.dialogs;
...
import com.lembed.lite.studio.dataviewers.charts.provider.ChartFactory;
import com.lembed.lite.studio.dataviewers.charts.provider.IChartField;
...
public class ChartDialog extends Dialog {
    ...
    private void saveState() {
            ...
            if (settings == null) {
                stViewer.getViewerSettings().addNewSection(TAG_SECTION_CHARTS_STATE);
                settings = stViewer.getViewerSettings().getSection(TAG_SECTION_CHARTS_STATE);
            }
     ...
     */
    private static ISTDataViewersField getLabelField(AbstractSTViewer viewer) {
