 ...
 *******************************************************************************/
package com.lembed.lite.studio.dataviewers.dialogs;
...
import com.lembed.lite.studio.dataviewers.abstractviewers.STDataViewersCSVExporterConstants;
...
public class STDataViewersExportToCSVDialog extends Dialog {
    ...
    protected void configureShell(Shell newShell) {
        ...
        newShell.setText("Export to CSV"); //$NON-NLS-1$
    }
    ...
    private void createOutputFileArea(Composite composite) {
        ...
        outputLabel.setText("Output file:"); //$NON-NLS-1$
        ...
        browseOutputButton.setText("File System..."); //$NON-NLS-1$
        ...
        browseOutputInWorkspaceButton.setText("Workspace..."); //$NON-NLS-1$
    ...
    private void createCSVConfigArea(Composite composite) {
        ...
        configGroup.setText("CSV Configuration"); //$NON-NLS-1$
        GridData layoutData = new GridData(SWT.FILL, SWT.FILL, true, true, 1, 1);
        ...
        separatorLabel.setText("CSV Separator:"); //$NON-NLS-1$
        layoutData = new GridData(SWT.LEFT, SWT.CENTER, false, false, 1, 1);
        ...
        if (exporter.isTreeViewerExporter()) {
            ...
            new Label(configGroup, SWT.NONE).setText("          "); //$NON-NLS-1$
        }

        showHiddenColumnsButton = new Button(configGroup, SWT.CHECK);
        showHiddenColumnsButton.setText("Export Hidden Columns"); //$NON-NLS-1$
        layoutData = new GridData(SWT.FILL, SWT.FILL, false, false, 1, 1);
    ...
    private void createTreePrefixConfigArea(Composite composite) {
        ...
        prefixConfigGroup.setText("Tree ascii-art drawing"); //$NON-NLS-1$
        GridData layoutData = new GridData(SWT.FILL, SWT.FILL, true, true, 1, 1);
        ...
        exportTreePrefixButton.setText("Export ascii-art tree"); //$NON-NLS-1$
        ...
        childLinkLabel.setText("Child Link:"); //$NON-NLS-1$
        layoutData = new GridData(SWT.LEFT, SWT.CENTER, false, false, 1, 1);
        ...
        noChildLinkLabel.setText("No-child Link:"); //$NON-NLS-1$
        layoutData = new GridData(SWT.LEFT, SWT.CENTER, false, false, 1, 1);
        ...
        childMarkerLabel.setText("Child Marker:"); //$NON-NLS-1$
        layoutData = new GridData(SWT.LEFT, SWT.CENTER, false, false, 1, 1);
        ...
        lastChildMarkerLabel.setText("Last child Marker:"); //$NON-NLS-1$
        layoutData = new GridData(SWT.LEFT, SWT.CENTER, false, false, 1, 1);
        ...
        leafMarkerLabel.setText("Leaf Marker:"); //$NON-NLS-1$
        layoutData = new GridData(SWT.LEFT, SWT.CENTER, false, false, 1, 1);
        ...
        nodeMarkerLabel.setText("Non-leaf Marker:"); //$NON-NLS-1$
        layoutData = new GridData(SWT.LEFT, SWT.CENTER, false, false, 1, 1);
    ...
    public String createPreview(String separator, String childMarker, String lastChildMarker, String nodeMarker,
        ...
        if (exportTreePrefix) {
            preview.append("Hierarchy").append(separator); //$NON-NLS-1$
        }
        ...
        preview.append("A23").append(separator).append("B23"); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    protected void okPressed() {
        ...
        if (f.exists()) {
            MessageDialog dialog = new MessageDialog(this.getShell(), "Warning: file already exists", null, "File \"" //$NON-NLS-1$ //$NON-NLS-2$
                    + f.getAbsolutePath() + "\" already exists.\n" + "Overwrite it anyway?", MessageDialog.WARNING, //$NON-NLS-1$ //$NON-NLS-2$
                    new String[] { "OK", "Cancel" }, 1); //$NON-NLS-1$ //$NON-NLS-2$
            if (dialog.open() > 0) {
                return;
            }
        }
    ...
    private static String activateSpecialChars(String text) {
        String result = text.replace("\\t", "\t"); //$NON-NLS-1$ //$NON-NLS-2$
        result = result.replace("\\n", "\n"); //$NON-NLS-1$ //$NON-NLS-2$

        return result;
    }

    private static String inactivateSpecialChars(String text) {
        String result = text.replace("\t", "\\t"); //$NON-NLS-1$ //$NON-NLS-2$
        result = result.replace("\n", "\\n"); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    private static void createSeparatorLine(Composite parent) {
    ...
    private void handleBrowseWorkspace() {
        ...
        dialog.setTitle("Output file"); //$NON-NLS-1$
    ...
    private void handleBrowse() {
        ...
        dialog.setText("Select output file"); //$NON-NLS-1$
