...
public class ProjectSelectionDialog extends SelectionStatusDialog {
	...
	Set<ILiteProject> fProjectsWithSpecifics;

	// sizing constants
	private final static int SIZING_SELECTION_WIDGET_HEIGHT = 250;
	private final static int SIZING_SELECTION_WIDGET_WIDTH = 300;

	public ProjectSelectionDialog(Shell parentShell, Set<ILiteProject> projectsWithSpecifics) {
		super(parentShell);
		setTitle(Messages.ProjectSelectionDialog_LiteProjectSelectionDialog);
		fProjectsWithSpecifics = projectsWithSpecifics;
		if (fProjectsWithSpecifics == null || fProjectsWithSpecifics.isEmpty()) {
			setMessage(Messages.ProjectSelectionDialog_NoLiteProjectFound);
		} else {
			setMessage(Messages.ProjectSelectionDialog_SelectLiteProject);
		}
	}
	...
	protected Control createDialogArea(Composite parent) {
		...
		fTableViewer.setLabelProvider(new LabelProvider() {
			...
			public String getText(Object element) {
				ILiteProject project = (ILiteProject) element;
				if (project != null) {
