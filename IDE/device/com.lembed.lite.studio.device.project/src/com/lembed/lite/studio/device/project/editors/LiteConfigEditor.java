...
public class LiteConfigEditor extends MultiPageEditorPart implements IResourceChangeListener , ICEditor,ICModelBasedEditor,ISelectionChangedListener, ICReconcilingListener{
				...
				if (type == IResource.FILE && kind == IResourceDelta.REMOVED
					...
					if ((flags & IResourceDelta.MOVED_TO) == IResourceDelta.MOVED_TO) {
						...
						Display.getDefault().asyncExec(() -> {
							LiteConfigEditor.this.getEditorSite().getPage().closeEditor(LiteConfigEditor.this, true);
						});
						return false;
					}
				}
