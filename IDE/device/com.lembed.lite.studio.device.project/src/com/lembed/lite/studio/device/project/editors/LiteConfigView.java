...
public class LiteConfigView extends ViewPart implements IResourceChangeListener{
	
	public final static String ID = "com.lembed.lite.studio.device.project.editors.LiteConfigView";
				...
				if (type == IResource.FILE && kind == IResourceDelta.REMOVED
					...
					if ((flags & IResourceDelta.MOVED_TO) == IResourceDelta.MOVED_TO) {
						...
						Display.getDefault().asyncExec(() -> {
							//LiteConfigView.this.getEditorSite().getPage().closeEditor(LiteConfigView.this, true);
						});
						return false;
					}
				}
