...
import com.lembed.lite.studio.device.core.data.CpComponent;
...
public class PackPropertyView extends PackInstallerView {
	...
	public static final String ID = "com.lembed.lite.studio.device.pack.ui.views.PackPropertyView"; //$NON-NLS-1$
	...
	protected void makeActions() {
		...
		fCopyAction.setImageDescriptor(CpPlugInUI.getImageDescriptor(CpPlugInUI.ICON_LITE));
	}
	...
	@Override
	public void handleRteEvent(LiteEvent event) {
