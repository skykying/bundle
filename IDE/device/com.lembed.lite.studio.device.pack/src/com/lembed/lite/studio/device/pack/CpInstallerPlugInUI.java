...
import com.lembed.lite.studio.device.pack.ui.perspectives.PackManagerPerspective;
...
public class CpInstallerPlugInUI extends AbstractUIPlugin implements IWorkbenchListener, IPerspectiveListener  {
	...
	// The plug-in ID
	public static final String PLUGIN_ID = "com.lembed.lite.studio.device.pack"; //$NON-NLS-1$
	...
	public void start(BundleContext context) throws Exception {
		...
		CpPlugIn.addLiteListener(viewController);		
		Boolean isRunning = PlatformUI.isWorkbenchRunning();
		if(isRunning){
	...
	public void stop(BundleContext context) throws Exception {
		...
		CpPlugIn.removeLiteListener(viewController);
	...
	void startAutomaticTasks(IWorkbenchPage page, IPerspectiveDescriptor perspective) {
		if (PackManagerPerspective.ID.equals(page.getPerspective().getId())) {
			...
			String now = DeviceUIUtils.getCurrentDate();
	...
	public static void log(BackingStoreException e) {
