...
public class PackInstallerViewUtils {
	...
	public static void addManagementCommandsToLocalToolBar(IViewPart viewPart, IContributionManager manager) {
		String[] commandIds = { 
				"com.lembed.lite.studio.device.installer.commands.updateCommand", //$NON-NLS-1$
				"com.lembed.lite.studio.device.installer.commands.importdeviceCommand", //$NON-NLS-1$
				"com.lembed.lite.studio.device.installer.commands.reloadCommand", //$NON-NLS-1$
				"com.lembed.lite.studio.device.installer.commands.importFolderdevicesCommand" }; //$NON-NLS-1$
