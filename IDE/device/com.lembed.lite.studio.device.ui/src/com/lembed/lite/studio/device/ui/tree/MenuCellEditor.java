...
/**
 * A cell editor that presents a drop down menu. The cell editor's value is the
 * selected menu item.
 */
public class MenuCellEditor extends CellEditor {
	...
	/**
	 * This is the menu item selection listener used to apply the selected menu
	 * item.
	 */
	...
	private void showMenu() {
		...
		Rectangle rc2 = Geometry.toDisplay(parent, rc); // convert to screen
														// coordinates
