 ...
 *
 */
public class LiteEditorPageHeader extends Composite {
	...
	public LiteEditorPageHeader(Composite parent, int style) {
		super(parent, style);
	...
	public IAction addSaveAction() {
		...
		saveAction.setToolTipText(CpStringsUI.LiteManagerWidget_ApplyAndSave);
	...
	public IAction addHelpAction() {
		...
		helpAction.setToolTipText(CpStringsUI.LiteEditorPageHeader_ShowHelp);
