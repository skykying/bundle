 ...
 */
public class LiteDeviceInfoWidget extends Composite {
	private Text text;
	private Table table;
	...
	protected ILiteColumnAdvisor fBookColumnAdvisor = null;
	protected ILiteColumnAdvisor fBoardColumnAdvisor = null;
	...
	public class LiteBookContentProvider extends TreeObjectContentProvider {
		@Override
	...
	public class LiteBoardContentProvider extends TreeObjectContentProvider {
		@Override
		public Object[] getElements(Object inputElement) {
	...
	public class LiteBoardLabelProvider extends LabelProvider {
		@Override
	 ...
	 */
	class LiteBookColumnAdvisor extends LiteColumnAdvisor {
		/**
		 ...
		 */
		public LiteBookColumnAdvisor(ColumnViewer columnViewer) {
			super(columnViewer);
		}
	 ...
	 * @param style
	 */
	public LiteDeviceInfoWidget(Composite parent) {
		...
		btnSelect.setText(CpStringsUI.LiteDeviceInfoWidget_btnSelect_text);	
		...
		lblFamilyLabel.setText(CpStringsUI.LiteDeviceInfoWidget_lblFamily_text);
		...
		lblSubfamilyLabel.setText(CpStringsUI.LiteDeviceInfoWidget_lblSubFamily_text);
		...
		lblEndianLabel.setText(CpStringsUI.LiteDeviceSelectorWidget_Endian);
		...
		lblBooks.setText(CpStringsUI.LiteDeviceInfoWidget_lblBooks_text);
		new Label(this, SWT.NONE);

		lblDescription = new Label(this, SWT.NONE);
		lblDescription.setText(CpStringsUI.LiteDeviceInfoWidget_lblDescription_text);
		new Label(this, SWT.NONE);
		new Label(this, SWT.NONE);
		...
		fBookColumnAdvisor = new LiteBookColumnAdvisor(tableViewer);
		ColumnViewerToolTipSupport.enableFor(tableViewer);

		tableViewer.setContentProvider(new LiteBookContentProvider());
		// tableViewer.setLabelProvider(new LiteBookLabelProvider());
		...
		lblBoards.setText(CpStringsUI.LiteDeviceInfoWidget_lblBoards_text);
		new Label(this, SWT.NONE);
		...
		treeViewer.setContentProvider(new LiteBoardContentProvider());
		// treeViewer.setLabelProvider(new LiteBoardLabelProvider());

		fBoardColumnAdvisor = new LiteBookColumnAdvisor(treeViewer);
	...
	protected void updateControls() {
		...
		if (fDeviceInfo != null) {
			...
			if (fDeviceInfo.getDevice() != null) {
				...
				description = CpStringsUI.LiteDeviceInfoWidget_lblMissing_text;
				deviceName += " (" + CpStringsUI.LiteDeviceInfoWidget_lblMissing_text + ")"; //$NON-NLS-1$ //$NON-NLS-2$
			}
		}
	...
	private String getFpuString(String fpu) {
		if (fpu != null) {
			...
			case CmsisConstants.SP_FPU:
				return CpStringsUI.LiteDeviceSelectorWidget_SinglePrecision;
			case CmsisConstants.DP_FPU:
				return CpStringsUI.LiteDeviceSelectorWidget_DoublePrecision;
			default:
				return CpStringsUI.LiteDeviceSelectorWidget_none;
			}
		}
		return CmsisConstants.EMPTY_STRING;
	}
