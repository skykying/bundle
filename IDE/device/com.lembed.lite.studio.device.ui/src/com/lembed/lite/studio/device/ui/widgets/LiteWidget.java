...
public abstract class LiteWidget implements ILiteEventListener {

	protected ILiteModelController fModelController = null; // contains
															// RteComponents
	protected ILiteColumnAdvisor fColumnAdvisor = null;
	 ...
	 */
	public ILiteColumnAdvisor getColumnAdvisor() {
	 ...
	 *            IColumnAdvisor
	 */
	public void setColumnAdvisor(ILiteColumnAdvisor columnAdvisor) {
