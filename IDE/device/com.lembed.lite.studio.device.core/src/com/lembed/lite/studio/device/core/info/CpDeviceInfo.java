...
public class CpDeviceInfo extends CpItem implements ICpDeviceInfo {
	 ...
	 */
	public CpDeviceInfo(ICpItem parent, ILiteDeviceItem device) {
		super(parent, CmsisConstants.DEVICE_TAG);
		setLiteDevice(device);
	}
	...
	@Override
	public void setLiteDevice(ILiteDeviceItem device) {
		if(device != null) {
	...
	@Override
	public Map<String, Long> getMemoryBankSize() {
		...
		for(ICpItem item : mems) {
			...
			maps.put(m.getEffectiveName(), new Long(size));
		}
	...
	@Override
	public Map<String, Long> getMemoryBankOffset() {
		HashMap<String,Long> maps = new HashMap<String,Long>();
		...
		for(ICpItem item : mems) {
			...
			maps.put(m.getEffectiveName(), new Long(offset));
		}
