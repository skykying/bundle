...
package com.lembed.lite.studio.device.common;
...
//	static public final String TVARIANT		= "Tvariant";		//$NON-NLS-1$
	...
	public static final String LITE_TOOLCHAIN_ADAPTER = "toolChainAdapter"; //$NON-NLS-1$
	public static final String LITE_CONFIG = "pack"; //$NON-NLS-1$
	public static final String LITE_TOOLCHAIN = "toolchain"; //$NON-NLS-1$
	public static final String LITE_CONFIG_FILE = "projectConfig"; //$NON-NLS-1$
	
	public static final String LITE_PROJECT_FEATURE = "feature"; //$NON-NLS-1$
	...
	static public final String CONFIG_VERSIONS = "Cversion";
	static public final String PACK = "pack";

	static public final String LITE_COMPONENTS_CONFIGS_H = "cmsis_config_h"; //$NON-NLS-1$
	static public final String LITE				= "sys"; 		//$NON-NLS-1$
	public static String LITE_INCLUDE 			= "inc";		//$NON-NLS-1$

	public static String LITE_INCLUDE_INDICATION = "LITE_INCLUDE_INDICATION" ; //$NON-NLS-1$
	public static String LITE_SOURCE_INDICATION  = "LITE_SOURCE_INDICATION" ; //$NON-NLS-1$

	

	
	
	static public final String LITEDIR			= "components/"; 		//$NON-NLS-1$
	static public final String _LITE_			= "_LITE_"; 		//$NON-NLS-1$
	static public final String RTECONFIG		= "pack";	//$NON-NLS-1$
	static public final String DOT_RTECONFIG	= ".pack";	//$NON-NLS-1$
	...
	static public final String REPO_LEMBED		= "LEMBED"; //$NON-NLS-1$
	static public final String REPO_LEMBED_SERVER	= "www.lembed.com"; //$NON-NLS-1$
	static public final String REPO_LEMBED_PACK_SERVER = "https://github.com/Lembed/cmsis-addon/raw/master/"; //$NON-NLS-1$
	static public final String REPO_LEMBED_INDEX_FILE = "index.idx"; //$NON-NLS-1$
	static public final String REPO_LEMBED_PINDEX_FILE = "index.pidx"; //$NON-NLS-1$
	static public final String REPO_LEMBED_INDEX_URL = REPO_LEMBED_PACK_SERVER + REPO_LEMBED_PINDEX_FILE;
	...
	public static final String LITE_NATURE_ID = "com.lembed.lite.studio.device.project.impl.LiteProjectNature"; //$NON-NLS-1$
	...
	static public final String CMSIS_LITE = "cmsis_lite";		 						//$NON-NLS-1$
	static public final String CMSIS_LITE_VAR = "${cmsis_lite}";		 				//$NON-NLS-1$
	static public final String CMSIS_LITE_BEGIN_VAR = "${cmsis_lite:begin}"; 			//$NON-NLS-1$
	static public final String CMSIS_LITE_END_VAR   = "${cmsis_lite:end}";				//$NON-NLS-1$
	...
	static public final String PROJECT_LOCAL_PATH 	= "../"; //$NON-NLS-1$
	static public final String PROJECT_ABS_PATH		= "${ProjDirPath}/"; 				//$NON-NLS-1$
	static public final String PROJECT_LITE_PATH    	= PROJECT_LOCAL_PATH + LITE;

	static public final String LITE_LITE_Components_h = "components.h";  				//$NON-NLS-1$
	static public final String CMSIS_device_header = "CMSIS_device_header";  			//$NON-NLS-1$
	
	public static final String TADAPTER_ID = "Tadapter"; //$NON-NLS-1$
	
	static public final String FEATURE_PROJECT_INFO = "ProjFeature"; //$NON-NLS-1$
	
	static public final String FEATURE_INCLUDE_DIR_KEY = "TIncludeDir"; //$NON-NLS-1$
	static public final String FEATURE_SOURCE_DIR_KEY = "TSourceDir"; //$NON-NLS-1$
	static public final String FEATURE_SYSTEM_DIR_KEY = "TSystemDir"; //$NON-NLS-1$
	static public final String FEATURE_LINKER_SCRIPT_DIR_KEY = "TScriptDir"; //$NON-NLS-1$
	static public final String FEATURE_LITE_DIR_KEY = "T_LITE"; //$NON-NLS-1$
	static public final String FEATURE_PROJECT_EXTENSION = "Textension"; //$NON-NLS-1$
	static public final String FEATURE_PROJECT_TEMPLATE_LAST = "Tlast"; //$NON-NLS-1$
	static public final String FEATURE_PROJECT_MEMBANK_INFO = "TmembankInfo"; //$NON-NLS-1$
	
	static public final String FEATURE_PROJECT_STACKSIZE = "TStackSize"; //$NON-NLS-1$
	static public final String FEATURE_PROJECT_STACKMINSIZE = "TMiniStackSize"; //$NON-NLS-1$
	
	public static final String FEATURE_PROJECT_TEMPLATE_CMAIN = "Tmain"; //$NON-NLS-1$
	static public final String FEATURE_PROJECT_TEMPLATE_DEBUGGER_KEY="TDebugger";//$NON-NLS-1$
	static public final String FEATURE_PROJECT_TEMPLATE_TRACE_KEY="TTrace";//$NON-NLS-1$
	static public final String FEATURE_PROJECT_TEMPLATE_UTILS_KEY="TUtils";//$NON-NLS-1$
	static public final String FEATURE_PROJECT_TEMPLATE_SYSCALL_KEY="TSyscall";//$NON-NLS-1$
	static public final String FEATURE_PROJECT_TEMPLATE_RTOS_KEY = "TRtos";//$NON-NLS-1$
	
	static public final String FEATURE_PROJECT_TEMPLATE_FREERTOS_VALUE = "FreeRTOS";//$NON-NLS-1$
	static public final String FEATURE_PROJECT_TEMPLATE_MNUTTX_VALUE = "mNuttx";//$NON-NLS-1$
	static public final String FEATURE_PROJECT_TEMPLATE_NULL_VALUE = "none";//$NON-NLS-1$
	static public final String FEATURE_PROJECT_TEMPLATE_RTOS_NULL="none";//$NON-NLS-1$
	
	static public final String FEATURE_PROJECT_TEMPLATE_SYSCALL_FREESTANDING = "none";//$NON-NLS-1$
	static public final String FEATURE_PROJECT_TEMPLATE_POSIX_VALUE = "retarget";//$NON-NLS-1$
	static public final String FEATURE_PROJECT_TEMPLATE_SEMIHOSTING_VALUE = "semihosting";//$NON-NLS-1$
	
	static public final String FEATURE_PROJECT_TEMPLATE_TRACE_NULL = "NONE";//$NON-NLS-1$
	static public final String FEATURE_PROJECT_TEMPLATE_TRACE_DEBUG = "DEBUG";//$NON-NLS-1$
	static public final String FEATURE_PROJECT_TEMPLATE_TRACE_STDOUT = "STDOUT";//$NON-NLS-1$
	static public final String FEATURE_PROJECT_TEMPLATE_TRACE_ITM = "ITM";//$NON-NLS-1$
	
	static public final String FEATURE_PROJECT_TEMPLATE_DEBUGGER_JLINK = "JLink";//$NON-NLS-1$
	static public final String FEATURE_PROJECT_TEMPLATE_DEBUGGER_STLINK = "STlink";//$NON-NLS-1$
	static public final String FEATURE_PROJECT_TEMPLATE_DEBUGGER_NULL = "none";//$NON-NLS-1$
	
	static public final String FEATURE_PROJECT_TEMPLATE_UTILS_BUILDIN = "BuiltIn";//$NON-NLS-1$
	static public final String FEATURE_PROJECT_TEMPLATE_UTILS_NULL = "none";//$NON-NLS-1$
	
	static public final String FEATURE_PROJECT_OPTION_USE_MOSTWARNINGS = "TUseMostWarnings"; //$NON-NLS-1$
	static public final String FEATURE_PROJECT_OPTION_USE_WARNINGASERROR = "TUseWerror";//$NON-NLS-1$
	static public final String FEATURE_PROJECT_OPTION_USE_OG ="TUseOg";//$NON-NLS-1$
	static public final String FEATURE_PROJECT_OPTION_USE_SOME_WARNINGS = "TUseSomeWarnings";//$NON-NLS-1$
	static public final String FEATURE_PROJECT_OPTION_USE_NANO="TUseNano";//$NON-NLS-1$
	static public final String FEATURE_PROJECT_OPTION_USE_LTO="TUseLto";//$NON-NLS-1$
	static public final String FEATURE_PROJECT_OPTION_USE_EXCLUDE_UNUSED="TExcludeUnused";//$NON-NLS-1$
	
	static public final String FEATURE_PROJECT_OPTION_USE_COVERAGE="TGCoverage";//$NON-NLS-1$
