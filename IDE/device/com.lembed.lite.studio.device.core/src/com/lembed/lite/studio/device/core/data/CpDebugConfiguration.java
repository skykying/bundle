...
public class CpDebugConfiguration extends CpItem implements ICpDebugConfiguration {
	...
	public String toString() {
		return "CpDebugConfiguration [debugItems=" + debugItems + ", traceItem=" + traceItem + ", debugVars="
				+ debugVars + ", sdfFileName=" + sdfFileName + ", debugPorts=" + debugPorts + ", sequences=" + sequences
				+ ", memoryItems=" + memoryItems + ", defaultMemory=" + defaultMemory + ", startupMemory="
				+ startupMemory + ", algorithms=" + algorithms + "]";
	}
