...
import com.lembed.lite.studio.device.generic.IGenericListenerList;
 ...
 */
public interface ILiteEventProxy extends IGenericListenerList<ILiteEventListener, LiteEvent>, ILiteEventListener {
	 ...
	 */
	void emitLiteEvent(final String topic, Object data);	
}
