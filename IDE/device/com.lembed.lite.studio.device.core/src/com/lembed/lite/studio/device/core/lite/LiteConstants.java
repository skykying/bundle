...
/**
 * Utility class to define constants comment to lite framework
 */
public class LiteConstants {
	...
	public static final int COMPONENT_IGNORE_VVV = COMPONENT_IGNORE_VERSION | COMPONENT_IGNORE_VENDOR
			| COMPONENT_IGNORE_VARIANT;
