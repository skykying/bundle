 ...
 */
public class CpPlugIn extends Plugin implements ILiteEventProxy {

	// The plug-in ID
	public static final String PLUGIN_ID = "com.lembed.lite.studio.device.core"; //$NON-NLS-1$
	// Preference ID
	...
	private ILiteEventProxy liteEventProxy = new LiteEventProxy();
	...
	public void start(BundleContext bundleContext) throws Exception {
		...
		thePackManager.setLiteEventProxy(this);
	...
	public void stop(BundleContext bundleContext) throws Exception {
		...
		liteEventProxy.removeAllListeners();
		liteEventProxy = null;
	...
	public void setEnvironmentProvider(ICpEnvironmentProvider provider) {
		...
		liteEventProxy.removeListener(theEnvironmentProvider);
		theEnvironmentProvider = provider;
		liteEventProxy.addListener(theEnvironmentProvider);
	}
	 ...
	 */
	static public void addLiteListener(ILiteEventListener listener) {
		if(plugin != null) {
	 ...
	 * @param listener
	 */
	static public void removeLiteListener(ILiteEventListener listener) {
		if(plugin != null) {
	...
	@Override
	public void addListener(ILiteEventListener listener) {
		liteEventProxy.addListener(listener);
	}

	@Override
	public void removeListener(ILiteEventListener listener) {
		liteEventProxy.removeListener(listener);
	}
	...
	@Override
	public void notifyListeners(LiteEvent event) {
		liteEventProxy.notifyListeners(event);
	}

	@Override
	public void emitLiteEvent(String topic, Object data) {
		liteEventProxy.emitLiteEvent(topic, data);

	}

	@Override
	public void handle(LiteEvent event) {
		liteEventProxy.handle(event);
	}
