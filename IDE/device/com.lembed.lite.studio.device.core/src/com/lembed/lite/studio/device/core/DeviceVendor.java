...
public class DeviceVendor {
	...
	public static final String KEIL_DD2_URL= "http://www.keil.com/dd2/"; //$NON-NLS-1$
	public static final String KEIL_BOARD2_URL= "http://www.keil.com/boards2/"; //$NON-NLS-1$
	/**
	 * Returns vendor ID
	 * 
	 * @param vendorName
	...
	public static void fillMaps() {
		try {
			InputStream inputStream = FileLocator.openStream(CpPlugIn.getDefault().getBundle(),
					new Path("resources/deviceVendors.txt"), false); //$NON-NLS-1$
