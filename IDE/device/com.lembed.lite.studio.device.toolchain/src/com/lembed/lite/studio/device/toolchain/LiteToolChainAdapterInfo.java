 ...
 * com.lembed.lite.studio.device.toolchain.ToolchainAdapter extension point
 * 
 * @noextend This class is not intended to be subclassed by clients.
 * @noinstantiate This class is not intended to be instantiated by clients.
 */
public class LiteToolChainAdapterInfo {
	...
	private static class NullAdapter implements ILiteToolChainAdapter {
		...
		@Override
		public void resetToolChainOptions(IConfiguration configuration, IBuildSettings buildSettings)
	 ...
	 */
	public LiteToolChainAdapterInfo(IConfigurationElement element) {
	 ...
	 */
	public synchronized ILiteToolChainAdapter getToolChainAdapter() {
		ILiteToolChainAdapter adapter = null;
		try {
	...
	private ILiteToolChainAdapter createAdapter() throws CoreException {
		Object obj = fConfigElement.createExecutableExtension(CLASS);
		if (obj instanceof ILiteToolChainAdapter) {
			return (ILiteToolChainAdapter) obj;
		}
	...
	/**
	 * Returns toolchain family : corresponds to Tcompiler filter attribute in
	 * RTE model
	 * 
	 ...
	 * @param toolChain
	 *            IToolChain to match
	 * @return one of the following (best match is positive and has lower
	 *         weight)
	 *         <dl>
	 *         <dt>0
