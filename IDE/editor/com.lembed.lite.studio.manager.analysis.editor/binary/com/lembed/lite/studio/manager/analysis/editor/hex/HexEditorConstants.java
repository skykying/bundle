...
public class HexEditorConstants {
	/**
	 * Plugin name
	 */
	public final static String PLUGIN_NAME = "binary"; //$NON-NLS-1$

	/**
	 * Plugin ID
	 */
	public final static String PLUGIN_ID = "com.lembed.lite.studio.manager.analysis.editor." + PLUGIN_NAME; //$NON-NLS-1$
