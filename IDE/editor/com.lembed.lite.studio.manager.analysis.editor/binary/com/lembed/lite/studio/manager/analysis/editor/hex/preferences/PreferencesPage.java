...
public class PreferencesPage extends PreferencePage implements IWorkbenchPreferencePage {
	static FontData[] fontDefault = new FontData[] {new FontData(HexEditorConstants.DEFAULT_FONT_NAME, HexEditorConstants.DEFAULT_FONT_SIZE, HexEditorConstants.DEFAULT_FONT_STYLE)};
	FontData[] fontData;
	...
	private void initializeDefaults() {
		...
		//
		store.setDefault(HexEditorConstants.PROPERTY_MAX_UNDO_STEPS, HexEditorConstants.MAX_UNDO_STEPS);
	}
    ...
    protected Control createContents(Composite parent) {
		...
		//
		fontData = PreferenceConverter.getFontDataArray(getPreferenceStore(), HexEditorConstants.PROPERTY_FONT);
    ...
    public boolean performOk() {
		PreferenceConverter.setValue(getPreferenceStore(), HexEditorConstants.PROPERTY_FONT, fontData);
		colorBgEditor.store();
		colorFgEditor.store();
		colorBgTable.store();
		colorFgTable.store();
		...
		maxUndoSteps.store();
		getPreferenceStore().setValue(HexEditorConstants.PROPERTY_DEBUG_MODE, debugModeButton.getSelection());
    ...
    protected void performDefaults() {
		...
		debugModeButton.setSelection(getPreferenceStore().getDefaultBoolean(HexEditorConstants.PROPERTY_DEBUG_MODE));
	...
	static public void initializeFontDefaults(IPreferenceStore store) {
		PreferenceConverter.setDefault(store, HexEditorConstants.PROPERTY_FONT, fontDefault);
	}
	...
	static public void initializeColorDefaults(IPreferenceStore store) {
		...
		//
		PreferenceConverter.setDefault(store, HexEditorConstants.PROPERTY_COLOR_BACKGROUND_TABLE, HexEditorConstants.COLOR_BACKGROUND_TABLE);
		PreferenceConverter.setDefault(store, HexEditorConstants.PROPERTY_COLOR_BACKGROUND_EDITOR, HexEditorConstants.COLOR_BACKGROUND_EDITOR);
		PreferenceConverter.setDefault(store, HexEditorConstants.PROPERTY_COLOR_BACKGROUND_CHANGED_CELL, HexEditorConstants.COLOR_BACKGROUND_CHANGED_CELL);
		PreferenceConverter.setDefault(store, HexEditorConstants.PROPERTY_COLOR_BACKGROUND_INSERTED_CELL, HexEditorConstants.COLOR_BACKGROUND_INSERTED_CELL);
		PreferenceConverter.setDefault(store, HexEditorConstants.PROPERTY_COLOR_BACKGROUND_UNDO, HexEditorConstants.COLOR_BACKGROUND_UNDO);
		PreferenceConverter.setDefault(store, HexEditorConstants.PROPERTY_COLOR_BACKGROUND_FIND_RESULT, HexEditorConstants.COLOR_BACKGROUND_FIND_RESULT);
		PreferenceConverter.setDefault(store, HexEditorConstants.PROPERTY_COLOR_BACKGROUND_SELECTED, HexEditorConstants.COLOR_BACKGROUND_SELECTED);
		//
		// Set default foreground colors
		//
		PreferenceConverter.setDefault(store, HexEditorConstants.PROPERTY_COLOR_FOREGROUND_TABLE, HexEditorConstants.COLOR_FOREGROUND_TABLE);
		PreferenceConverter.setDefault(store, HexEditorConstants.PROPERTY_COLOR_FOREGROUND_EDITOR, HexEditorConstants.COLOR_FOREGROUND_EDITOR);
		PreferenceConverter.setDefault(store, HexEditorConstants.PROPERTY_COLOR_FOREGROUND_CHANGED_CELL, HexEditorConstants.COLOR_FOREGROUND_CHANGED_CELL);
		PreferenceConverter.setDefault(store, HexEditorConstants.PROPERTY_COLOR_FOREGROUND_INSERTED_CELL, HexEditorConstants.COLOR_FOREGROUND_INSERTED_CELL);
		PreferenceConverter.setDefault(store, HexEditorConstants.PROPERTY_COLOR_FOREGROUND_UNDO, HexEditorConstants.COLOR_FOREGROUND_UNDO);
		PreferenceConverter.setDefault(store, HexEditorConstants.PROPERTY_COLOR_FOREGROUND_FIND_RESULT, HexEditorConstants.COLOR_FOREGROUND_FIND_RESULT);
		PreferenceConverter.setDefault(store, HexEditorConstants.PROPERTY_COLOR_FOREGROUND_SELECTED, HexEditorConstants.COLOR_FOREGROUND_SELECTED);
	}
	...
	private void createColorPanel(Composite mainPanel) {
		...
		colorBgTable = new ColorFieldEditor(HexEditorConstants.PROPERTY_COLOR_BACKGROUND_TABLE, "", colorBgTablePanel); //$NON-NLS-1$
		...
		colorFgTable = new ColorFieldEditor(HexEditorConstants.PROPERTY_COLOR_FOREGROUND_TABLE, "", colorFgTablePanel); //$NON-NLS-1$
		...
		colorBgEditor = new ColorFieldEditor(HexEditorConstants.PROPERTY_COLOR_BACKGROUND_EDITOR, "", colorBgCellEditorPanel); //$NON-NLS-1$
		...
		colorFgEditor = new ColorFieldEditor(HexEditorConstants.PROPERTY_COLOR_FOREGROUND_EDITOR, "", colorFgCellEditorPanel); //$NON-NLS-1$
		...
		colorBgChangedRow = new ColorFieldEditor(HexEditorConstants.PROPERTY_COLOR_BACKGROUND_CHANGED_CELL, "", colorBgChangedCellPanel); //$NON-NLS-1$
		...
		colorFgChangedRow = new ColorFieldEditor(HexEditorConstants.PROPERTY_COLOR_FOREGROUND_CHANGED_CELL, "", colorFgChangedCellPanel); //$NON-NLS-1$
		...
		colorBgInsertedRow = new ColorFieldEditor(HexEditorConstants.PROPERTY_COLOR_BACKGROUND_INSERTED_CELL, "", colorBgInsertedCellPanel); //$NON-NLS-1$
		...
		colorFgInsertedRow = new ColorFieldEditor(HexEditorConstants.PROPERTY_COLOR_FOREGROUND_INSERTED_CELL, "", colorFgInsertedCellPanel); //$NON-NLS-1$
		...
		colorBgUndoedRow = new ColorFieldEditor(HexEditorConstants.PROPERTY_COLOR_BACKGROUND_UNDO, "", colorBgUndoPanel); //$NON-NLS-1$
		...
		colorFgUndoedRow = new ColorFieldEditor(HexEditorConstants.PROPERTY_COLOR_FOREGROUND_UNDO, "", colorFgUndoPanel); //$NON-NLS-1$
		...
		colorBgFindResultRow = new ColorFieldEditor(HexEditorConstants.PROPERTY_COLOR_BACKGROUND_FIND_RESULT, "", colorBgFindResultPanel); //$NON-NLS-1$
		...
		colorFgFindResultRow = new ColorFieldEditor(HexEditorConstants.PROPERTY_COLOR_FOREGROUND_FIND_RESULT, "", colorFgFindResultPanel); //$NON-NLS-1$
		...
		colorBgSelectedRow = new ColorFieldEditor(HexEditorConstants.PROPERTY_COLOR_BACKGROUND_SELECTED, "", colorBgSelectedPanel); //$NON-NLS-1$
		...
		colorFgSelectedRow = new ColorFieldEditor(HexEditorConstants.PROPERTY_COLOR_FOREGROUND_SELECTED, "", colorFgSelectedPanel); //$NON-NLS-1$
	...
	private static void createColorHeader(Composite colorInnerPanel) {
		//
		// Header
		//
	...
	private static void createPluginAssociationPanel(Composite mainPanel) {
		...
		associationButton.addSelectionListener(new SelectionAdapter() {
			@Override
            public void widgetSelected(SelectionEvent e) {
				HexUtils.registerPluginForAllExtensions();
			}
		});
		...
		disAssociationButton.addSelectionListener(new SelectionAdapter() {
			@Override
            public void widgetSelected(SelectionEvent e) {
				HexUtils.removePluginFromAllExtensions();
			}
		});
	}
	...
	private void createDebugPanel(Composite mainPanel) {
		...
		debugModeButton.setSelection(getPreferenceStore().getBoolean(HexEditorConstants.PROPERTY_DEBUG_MODE));
	}
	...
	private void createUndoPanel(Composite mainPanel) {
		...
		// "Undo" text field
		//
		maxUndoSteps = new IntegerFieldEditor(HexEditorConstants.PROPERTY_MAX_UNDO_STEPS, Messages.PreferencesPage_42, undoSettingsGroup, 4);
