...
public class GotoDialog extends Dialog {
	...
	protected void okPressed() {
		...
		if (sAddress.length() == 0) {
			MessageDialog.openError(getShell(), HexEditorConstants.DIALOG_TITLE_ERROR, Messages.GotoDialog_11);
			txtAddress.setFocus();
			return;
		} // if
		...
		try {
			...
			MessageDialog.openError(getShell(), HexEditorConstants.DIALOG_TITLE_ERROR, Messages.GotoDialog_12 + ((addressIsDec) ? Messages.GotoDialog_13 : Messages.GotoDialog_14) + Messages.GotoDialog_15);
			txtAddress.setFocus();
		...
		if (iAddress < 0) {
			MessageDialog.openError(getShell(), HexEditorConstants.DIALOG_TITLE_ERROR, Messages.GotoDialog_16);
			txtAddress.setFocus();
			txtAddress.selectAll();
			return;
		} // if
