...
public class YAMLContentOutlinePage extends ContentOutlinePage {
	...
	protected class ContentProvider implements ITreeContentProvider {
		...
		public void parse(IDocument document) {
			...
			try {
				...
				EditorLog.logger.info( "Syntax error found during parsing for outlinew view. Parsing stopped." );
			}
		}
	...
	public YAMLContentOutlinePage(IDocumentProvider provider, YEditor editor ) {
		super();
	...
	public void selectionChanged( SelectionChangedEvent event ) {
		...
		EditorLog.logger.info("Select in the outline view changed");
