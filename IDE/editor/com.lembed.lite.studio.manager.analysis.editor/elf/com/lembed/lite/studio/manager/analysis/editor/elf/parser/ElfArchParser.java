...
public class ElfArchParser extends ElfParserBase {

	public ElfArchParser(IEditorConsole editorConsole, String binaryPath) {
	...
	public ParserResult parseResult(String line, IProject project) {
		...
		try {
			...
			return new ElfArchParserResult(key, value);
