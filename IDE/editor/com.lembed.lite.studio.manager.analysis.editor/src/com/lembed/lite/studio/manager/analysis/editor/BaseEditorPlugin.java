 ...
 ******************************************************************************/
package com.lembed.lite.studio.manager.analysis.editor;
 ...
 */
public class BaseEditorPlugin extends AbstractUIPlugin {

	// The plug-in ID
	public static final String PLUGIN_ID = "com.lembed.lite.studio.manager.analysis.editor"; //$NON-NLS-1$

	// The shared instance  
	private static BaseEditorPlugin plugin;
	...
	public void start(BundleContext context) throws Exception {
		super.start(context);
		plugin = this;
		EditorLog.initializeTraceLogger();		
	}
	 ...
	 */
	public static BaseEditorPlugin getDefault() {
		return plugin;
	}
