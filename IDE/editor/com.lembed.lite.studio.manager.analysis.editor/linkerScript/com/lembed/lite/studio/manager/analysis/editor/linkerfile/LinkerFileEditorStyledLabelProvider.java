 ...
 *
 */
public class LinkerFileEditorStyledLabelProvider extends StyledCellLabelProvider {
    ...
    public LinkerFileEditorStyledLabelProvider( ColorManager colorManager ) {
    ...
    public void update(ViewerCell cell) {
        ...
        if( e instanceof LinkerFileOutlineElement ){
            LinkerFileOutlineElement element = (LinkerFileOutlineElement) e;
            ...
            if( showTags ){
                styledString.append( " : " + element.section.getType(), TAG_STYLER );
            }
     ...
     */
    private String elementLabel( LinkerFileOutlineElement element ){
    ...
    public Image getImage(Object element) {
        ...
        if( element instanceof LinkerFileOutlineElement ){
            ...
            LinkerFileOutlineElement segment = ( LinkerFileOutlineElement ) element;
            if( segment.type == LinkerFileOutlineElement.SECTION_ITEM ){
                return get( IMG_DOCUMENT );
            } else if( segment.type == LinkerFileOutlineElement.LINKER_ITEM ){
                if( 0 == segment.children.size() ){
                    return get( IMG_MAPPINGSCALAR );
                } else {
                    return get( IMG_MAPPING );
                }
            } else if( segment.type == LinkerFileOutlineElement.GROUP_ITEM ){
                if( 0 == segment.children.size() ){
