...
import com.lembed.lite.studio.manager.analysis.editor.utils.Utils;

import org.yaml.snakeyaml.Yaml;

public class LinkerFileFormatter {

    private final DumperOptions options;
    
    private LinkerFileFormatter(Builder builder) {
    ...
    public static class Builder {
        ...
        public LinkerFileFormatter build() {
            return new LinkerFileFormatter(this);
        }
    }
