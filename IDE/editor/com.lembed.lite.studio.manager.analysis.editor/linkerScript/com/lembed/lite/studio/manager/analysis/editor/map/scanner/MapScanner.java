...
public class MapScanner extends BufferedRuleBasedScanner {

    private ColorManager colorManager;

    public MapScanner(ColorManager colorManager) {
        ...
        IToken keyToken = new MapToken(keyAttr, MapToken.KEY);
        ...
        IToken scalarToken = new MapToken(scalarAttr, MapToken.SCALAR);
        ...
        IToken commentToken = new MapToken(commentAttr, MapToken.COMMENT);
        ...
        IToken documentStartToken = new MapToken(documentAttr, MapToken.DOCUMENT_START);
        IToken documentEndToken = new MapToken(documentAttr, MapToken.DOCUMENT_END);
        ...
        IToken anchorToken = new MapToken(anchorAttr, MapToken.ANCHOR);

        TextAttribute opsAttr = tokenAttribute(
                store,
		...
		IToken opsToken = new MapToken(opsAttr, MapToken.OPERATORS);

        IToken indicatorCharToken = new MapToken(new TextAttribute(null),
                MapToken.INDICATOR_CHARACTER);
        ...
        IToken tagPropToken = new MapToken(tagAttr, MapToken.TAG_PROPERTY);
        ...
        IToken predefinedValToken = new MapToken(constantAttr, MapToken.CONSTANT);

        IToken whitespaceToken = new MapToken(new TextAttribute(null), MapToken.WHITESPACE);
        
        TextAttribute directiveAttr = tokenAttribute(
                store,
                PreferenceConstants.COLOR_CONSTANT,
                PreferenceConstants.BOLD_CONSTANT,
                PreferenceConstants.ITALIC_CONSTANT,
        ...
        IToken directiveToken = new MapToken(directiveAttr, MapToken.DIRECTIVE );
        ...
        rules.add(new EndOfLineRule("Discarded", directiveToken));
        rules.add(new EndOfLineRule("Allocating", directiveToken));
        rules.add(new EndOfLineRule("Archive", directiveToken));
        rules.add(new EndOfLineRule("Memory", directiveToken));
        rules.add(new EndOfLineRule("Linker", directiveToken));
        rules.add(new EndOfLineRule("OUTPUT",directiveToken));
        ...
        //rules.add(new MultiLineRule("/",".o", commentToken));
        
        //rules.add(new IndicatorCharacterRule(indicatorCharToken));
        //rules.add(new WhitespaceRule(whitespaceToken));
        
        rules.add(new WordPatternRule(new StarWordDetector(), "*", "", anchorToken));
        ...
        rules.add(new DigitRule(anchorToken));
