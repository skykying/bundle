...
import com.lembed.lite.studio.manager.analysis.editor.linker.template.LinkerFileEditorCompletionProcessor;



public class LinkerFileEditorSourceViewerConfiguration extends TextSourceViewerConfiguration {

	protected LinkerFileScanner linkerFileScanner;
	protected ColorManager colorManager;
	
	public LinkerFileEditorSourceViewerConfiguration(){
	...
	public IPresentationReconciler getPresentationReconciler( ISourceViewer sourceViewer ){
		...
		DefaultDamagerRepairer dr = new LinkerFileEditorDamageRepairer(getScanner() );
	...
	public IContentAssistant getContentAssistant( ISourceViewer sourceViewer ){
	    ...
	    IContentAssistProcessor cap = new LinkerFileEditorCompletionProcessor();
	    ca.setContentAssistProcessor(cap, IDocument.DEFAULT_CONTENT_TYPE);
	    
	    /**
	     * added inspire CDT source code
	     */
	...
	protected LinkerFileScanner getScanner(){
		
		if( linkerFileScanner == null ){
			linkerFileScanner = new LinkerFileScanner( colorManager );
		}
		return linkerFileScanner;		
	}
	...
	protected Map getHyperlinkDetectorTargets(ISourceViewer sourceViewer) {
		...
		targets.put(ContentTypeIdForLinkerFile.CONTENT_TYPE_ID_LINKERFILE, null);
		return targets;		
	}
	...
	public ITextDoubleClickStrategy getDoubleClickStrategy(ISourceViewer sourceViewer, String contentType){
	    return new LinkerFileEditorDoubleClickStrategy();
	}
}
