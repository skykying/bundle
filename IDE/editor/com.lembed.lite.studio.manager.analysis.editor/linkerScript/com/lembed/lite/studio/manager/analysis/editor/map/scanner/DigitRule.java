...
public class DigitRule implements IRule {
    ...
    private IToken token; // \w + - / \. \\( \) \? \@ \$ < = > \|
    private String firstCharRegex = "\\d";
    private String otherCharRegex = "x X a-f A-F \\d";
    private String endCharRegex = "x X a-f A-F \\d";

    public DigitRule( IToken token ) {
        this.token = token;
    }
    ...
    public IToken evaluate(ICharacterScanner scanner) {
        ...
        EditorLog.logger.info("Evaluating DigitRule");
