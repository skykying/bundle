...
import com.lembed.lite.studio.manager.analysis.editor.map.scanner.MapScanner;



public class MapEditorSourceViewerConfiguration extends TextSourceViewerConfiguration {

	protected MapScanner mapScanner;
	protected ColorManager colorManager;
	
	public MapEditorSourceViewerConfiguration(){
	...
	public IPresentationReconciler getPresentationReconciler( ISourceViewer sourceViewer ){
		...
		DefaultDamagerRepairer dr = new MapEditorDamageRepairer(getScanner() );
	...
	protected MapScanner getScanner(){
		
		if( mapScanner == null ){
			mapScanner = new MapScanner( colorManager );
		}
		return mapScanner;		
	}
	...
	protected Map getHyperlinkDetectorTargets(ISourceViewer sourceViewer) {
		...
		targets.put(ContentTypeIdForMap.CONTENT_TYPE_ID_LINKERFILE, null);
		return targets;		
	}
	...
	public ITextDoubleClickStrategy getDoubleClickStrategy(ISourceViewer sourceViewer, String contentType){
	    return new MapEditorDoubleClickStrategy();
	}
}
