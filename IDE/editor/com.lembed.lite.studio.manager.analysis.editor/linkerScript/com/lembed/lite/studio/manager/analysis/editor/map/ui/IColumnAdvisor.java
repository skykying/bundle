...
public interface IColumnAdvisor {
	...
	public static final int SUFFIX_BUTTON_WIDTH = 16; // width and height of the
														// button in
														// INPLACE_CHECK cell
	 ...
	 *            column index of the cell
	 * @param newVal
	 *            newly selected item that the button associates with
	 */
	 ...
	 *            column index of the cell
	 * @param newVal
	 *            newly selected item that the upper spinner associates with
	 */
	 ...
	 *            column index of the cell
	 * @param newVal
	 *            newly selected item that the down spinner associates with
	 */
	 ...
	 * 
	 * @param cellBounds
	 *            the cell's bound excluding suffix button if it exits
	 * @param obj
	 *            cell's object
	 * @param columnIndex
	 *            cell's column index
	 ...
	 *            column index of the cell
	 * @param newVal
	 *            newly selected item that the right aligned button associates
	 *            with
	 */
	 ...
	 * @param columnIndex
	 *            the cell's column index
	 * @return The bounds of the button in the cell, or an empty bound if the
	 ...
	 * Return null if the object is of type CHECK, return current selected
	 * string if the object is of type COMBO
	 * 
	 * @param obj
	 *            cell object
	 * @param columnIndex
