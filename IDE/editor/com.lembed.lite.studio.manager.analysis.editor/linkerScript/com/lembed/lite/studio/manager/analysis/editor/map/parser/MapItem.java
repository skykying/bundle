...
public class MapItem implements IMapItem {
	...
	private LinkedList<IMapItem> fChildren;

	/**
	 *
	 */
	public MapItem(EItemType itemType, int line, IMapItem parent) {
		fParent = parent;
		fItemType = itemType;
		fStartLine = line;
		fEndLine = line;
	...
	@Override
	public Collection<IMapItem> getChildren() {
		return fChildren;
	}

	@Override
	public IMapItem getLastChild() {
	...
	@Override
	public void addChild(IMapItem child) {
		fChildren.add(child);
	}
