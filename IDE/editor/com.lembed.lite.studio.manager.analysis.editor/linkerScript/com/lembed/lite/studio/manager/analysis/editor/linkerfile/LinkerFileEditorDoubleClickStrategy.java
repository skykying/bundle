...
import com.lembed.lite.studio.manager.analysis.editor.utils.EditorUtils;
 ...
 */
public class LinkerFileEditorDoubleClickStrategy extends DefaultTextDoubleClickStrategy {
    ...
    public void doubleClicked(ITextViewer part){
        ...
        try {
            ...
            if( SelectDirection.NONE != selectDirection){
                EditorLog.logger.fine("Found quoted scalar at position " + offset + " on line" + EditorUtils.getLine(doc, offset));
                ...
                EditorLog.logger.fine("Found not quoted scalar at position " + offset + " on line" + EditorUtils.getLine(doc, offset));
            }
            
        } catch (BadLocationException e) {
            EditorLog.logException(e, "Failure during doubleclick action");
        }
