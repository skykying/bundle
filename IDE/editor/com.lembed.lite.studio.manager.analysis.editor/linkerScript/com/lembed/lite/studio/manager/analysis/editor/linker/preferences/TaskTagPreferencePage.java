...
import com.lembed.lite.studio.manager.analysis.editor.linker.preferences.tasktag.IStatusChangeListener;
import com.lembed.lite.studio.manager.analysis.editor.linker.preferences.tasktag.TaskTagConfigurationBlock;
...
public class TaskTagPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
    ...
    public void init(IWorkbench workbench) {
        ...
        setDescription("Linker File Task tag preferences");
