...
public class PredefinedValueRule implements IRule {
    ...
    public IToken evaluate(ICharacterScanner scanner) {
        ...
        fourCharacterRegex += "|KEEP|LONG|ADDR|FILL|"; //$NON-NLS-1$
        ...
        String fiveCharacterRegex = "|false|False|FALSE|ENTRY|ALIGN|"; //$NON-NLS-1$
        if( Pattern.matches(fiveCharacterRegex, s) ){
            return token;
        }
        
        s += (char) scanner.read();
        String sixCharacterRegex = "|MEMORY|ORIGIN|LENGTH|"; //$NON-NLS-1$
