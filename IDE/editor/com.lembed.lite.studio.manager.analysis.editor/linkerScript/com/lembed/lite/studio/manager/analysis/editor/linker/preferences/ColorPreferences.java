...
public class ColorPreferences extends PreferencePage implements
    ...
    public ColorPreferences() {
        ...
        setDescription("Linker File Color Preferences for syntax highlighting");
    ...
    protected void createFieldEditors(Composite parent) {
        ...
        addSyntaxCategory(
            ...
            PreferenceConstants.UNDERLINE_KEY, "KeyWords", parent);

        addSyntaxCategory(
            PreferenceConstants.COLOR_SCALAR,
            PreferenceConstants.BOLD_SCALAR,
            PreferenceConstants.ITALIC_SCALAR,
            PreferenceConstants.UNDERLINE_SCALAR, "Operators", parent);
        ...
        addSyntaxCategory(
            ...
            PreferenceConstants.UNDERLINE_ANCHOR, "Sections", parent);

        addSyntaxCategory(
            PreferenceConstants.COLOR_ALIAS,
            PreferenceConstants.BOLD_ALIAS,
            PreferenceConstants.ITALIC_ALIAS,
            PreferenceConstants.UNDERLINE_ALIAS, "Memorys", parent);
