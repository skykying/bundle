...
public class GlobalToolsPathsPreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
	...
	/** The Constant ID. */
	public static final String ID = "com.lembed.lite.studio.managedbuild.cross.preferencePage.globalToolsPaths"; //$NON-NLS-1$
	...
	public GlobalToolsPathsPreferencePage() {
		...
		setPreferenceStore(new ScopedPreferenceStore(ConfigurationScope.INSTANCE, CrossGccPlugin.PLUGIN_ID));
	...
	public void init(IWorkbench workbench) {
		...
		CrossGccPlugin.log("GlobalToolsPathsPage.init()"); //$NON-NLS-1$
	}
