...
import com.lembed.lite.studio.managedbuild.cross.preferences.DefaultPreferences;
...
public class PersistentPreferences {
	...
	private static String getString(String key, String defaultValue, IProject project) {
		...
		value = SharedDefaults.getInstance().getSharedDefaultsMap().get(CrossGccPlugin.PLUGIN_ID + "." + key); //$NON-NLS-1$
