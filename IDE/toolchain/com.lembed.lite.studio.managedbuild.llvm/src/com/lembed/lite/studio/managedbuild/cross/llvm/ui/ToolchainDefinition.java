...
public class ToolchainDefinition {
	...
	public static final String LEMBED_TOOLCHAIN_LLVM_CLANG_NAME = "Lembed Clang/LLVM bare-metal EABI"; //$NON-NLS-1$
	
	/** The Constant DEFAULT_TOOLCHAIN_NAME. */
	public static final String DEFAULT_TOOLCHAIN_NAME = LEMBED_TOOLCHAIN_LLVM_CLANG_NAME;
	...
	public ToolchainDefinition(String sName) {
		...
		fCmdRm = "rm"; //$NON-NLS-1$
		fCmdC = "clang"; //$NON-NLS-1$
		fCmdCpp = "clang++"; //$NON-NLS-1$
		fCmdAr = "llvm-ar"; //$NON-NLS-1$
		fCmdObjcopy = "llvm-objcopy"; //$NON-NLS-1$
		fCmdObjdump = "llvm-objdump"; //$NON-NLS-1$
		fCmdSize = "llvm-size"; //$NON-NLS-1$
		fCmdNM = "llvm-nm"; //$NON-NLS-1$
		fCmdReadElf = "llvm-readelf"; //$NON-NLS-1$
		fCmdAddr2line = "llvm-addr2line"; //$NON-NLS-1$
	...
	private static final String CUSTOM_TOOLCHAINS_EXT_POTNT_ID = LlvmUIPlugin.PLUGIN_ID + ".toolchains"; //$NON-NLS-1$
	...
	static {
		...
		// 0
		fgList.add(new ToolchainDefinition(LEMBED_TOOLCHAIN_LLVM_CLANG_NAME, "")); //$NON-NLS-1$
		// 1
