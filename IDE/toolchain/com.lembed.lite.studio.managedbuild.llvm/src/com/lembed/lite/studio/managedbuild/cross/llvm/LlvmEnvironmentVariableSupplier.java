...
import com.lembed.lite.studio.managedbuild.cross.llvm.preferences.LlvmPreferenceStore;
...
public class LlvmEnvironmentVariableSupplier implements IConfigurationEnvironmentVariableSupplier {
	...
	public static void initializePaths() { //TODO: Is this actually called anywhere?
		...
		if (binPath != null && binPath.length()!=0) {
			...
			/**
			 * initialize environment variable cache values @2017.10.17
			 * below is disable, which is not modified
			 */
			if(pathStr == "1") { //$NON-NLS-1$
	 ...
	 * @return LlvmBuildEnvironmentVariable
	 */
