 ...
 */
public class ProjectToolsPathsPreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {

	// ------------------------------------------------------------------------

	/** The Constant ID. */
	public static final String ID = "com.lembed.lite.studio.managedbuild.cross.llvm.preferences.workspaceToolsPaths"; //$NON-NLS-1$
	 ...
	 */
	public ProjectToolsPathsPreferencePage() {
		super(GRID);

		setPreferenceStore(new ScopedPreferenceStoreWithoutDefaults(InstanceScope.INSTANCE, LlvmUIPlugin.PLUGIN_ID));
	...
	public void init(IWorkbench workbench) {
		 ...
		 LlvmUIPlugin.log("WorkspaceToolsPathsPage.init()"); //$NON-NLS-1$
	}
