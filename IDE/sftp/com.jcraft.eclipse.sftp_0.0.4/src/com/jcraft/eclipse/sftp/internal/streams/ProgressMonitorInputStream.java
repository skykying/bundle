 ...
 *******************************************************************************/
package com.jcraft.eclipse.sftp.internal.streams;
...
public abstract class ProgressMonitorInputStream extends FilterInputStream{
  ...
  public ProgressMonitorInputStream(InputStream in, long bytesTotal,
      int updateIncrement, IProgressMonitor monitor){
    super(in);
  ...
  protected abstract void updateMonitor(long bytesRead, long size,
