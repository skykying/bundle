...
public class SFTPPutAction extends PutAction{

  protected SFTPPutAction(ISynchronizePageConfiguration configuration){
    super(configuration, configuration.getSite().getSelectionProvider(),
        "SFTPPutAction.", Policy.getBundle()); //$NON-NLS-1$
  }

  public SFTPPutAction(ISynchronizePageConfiguration configuration,
  ...
  protected String getJobName(SyncInfoSet syncSet){
    return Policy.bind(
        "SFTPPutAction.0", new Integer(syncSet.size()).toString()); //$NON-NLS-1$
  }
