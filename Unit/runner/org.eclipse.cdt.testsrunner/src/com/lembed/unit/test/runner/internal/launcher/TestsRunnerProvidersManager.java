 ...
 *******************************************************************************/
package com.lembed.unit.test.runner.internal.launcher;
...
public class TestsRunnerProvidersManager {
	...
	private static final String TESTS_RUNNER_EXTENSION_POINT_ID = "com.lembed.unit.test.runner.core.TestsRunner"; //$NON-NLS-1$
