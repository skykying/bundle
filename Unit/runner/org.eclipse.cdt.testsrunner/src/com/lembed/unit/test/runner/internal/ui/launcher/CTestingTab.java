 ...
 *******************************************************************************/
package com.lembed.unit.test.runner.internal.ui.launcher;
...
public class CTestingTab extends CLaunchConfigurationTab {
	 ...
	 * extension point.
	 */
	private static final String TAB_ID = "com.lembed.unit.test.runner.testingTab"; //$NON-NLS-1$

	private static final String TESTING_PROCESS_FACTORY_ID = "com.lembed.unit.test.runner.TestingProcessFactory"; //$NON-NLS-1$
