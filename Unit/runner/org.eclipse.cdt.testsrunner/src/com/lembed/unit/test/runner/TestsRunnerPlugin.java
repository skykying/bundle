 ...
 *******************************************************************************/
package com.lembed.unit.test.runner;
...
import com.lembed.unit.test.runner.internal.launcher.TestsRunnerProvidersManager;
import com.lembed.unit.test.runner.internal.model.TestingSessionsManager;
import com.lembed.unit.test.runner.launcher.ITestsRunnerConstants;
...
public class TestsRunnerPlugin extends AbstractUIPlugin {
	...
	/** The plug-in ID. */
	private static final String PLUGIN_ID = "com.lembed.unit.test.runner.core"; //$NON-NLS-1$
