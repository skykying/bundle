...
public class JCuteView extends JFrame {
    ...
    public JCuteView() {
        ...
        menuBar3.add(menu5);
        menuBar3.add(menu6);
        compileButton.setIcon(GetImageIcon.getIcon("icons/Compile.gif"));
        startButton.setIcon(GetImageIcon.getIcon("icons/Restart.gif"));
        continueButton.setIcon(GetImageIcon.getIcon("icons/Continue.gif"));
        replayButton.setIcon(GetImageIcon.getIcon("icons/Replay.gif"));
        pauseButton.setIcon(GetImageIcon.getIcon("icons/Pause.gif"));
        cancelButton.setIcon(GetImageIcon.getIcon("icons/Cancel.gif"));
        optionsButton.setIcon(GetImageIcon.getIcon("icons/Options.gif"));
        quitButton.setIcon(GetImageIcon.getIcon("icons/Exit.gif"));
        aboutButton.setIcon(GetImageIcon.getIcon("icons/About.gif"));
        helpButton.setIcon(GetImageIcon.getIcon("icons/Help.gif"));
        junitButton.setIcon(GetImageIcon.getIcon("icons/junitlogo.gif"));
        ...
        browseSrcDirButton.setIcon(GetImageIcon.getIcon("icons/Dir.gif"));
        jLabel20.setText("Main Java File");
        browseMainJavaFileButton.setIcon(GetImageIcon.getIcon("icons/File.gif"));
