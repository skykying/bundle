...
public class CppUTestEclipsePlatform implements CUTPlatformAdaptor, SourceCodeProvider {
	...
	public void messageBox(String string) {
		MessageDialog.openInformation(workbenchWindow.getShell(), PLUGIN_NAME, string);
	...
	public String getFullText() {
		...
		if (activeEditor == null)
			return null;
		final AbstractTextEditor textEditor = (AbstractTextEditor) activeEditor.getAdapter(AbstractTextEditor.class);
		if (textEditor == null)
			return "";
