...
import com.lembed.unit.test.parser.Token;
...
public final class CppLangFunctionSignature implements LanguageUnit {
	...
	public CppCode getCode() {
		return new CppCode(returnType + " " + functionName + "(" + join(parameters, " ") + ")");
	}
	...
	public static class SignatureBuilder {
		...
		private boolean addTokenToCurrentTryOfReturnTyeAndFunctionName(String partOfFunctionDeclaration) {
			if (!hasReturnType) {
