...
public class CppPart {
	public enum Type {
		MAYBE_NEW_FUNCTION, END_OF_FUNCTION_SIGNATURE, PART_OF_LONG_FUNCTION_NAME, MAYBE_PART_OF_FUNCTION_NAME, PARAMETER, END_OF_FUNCTION, TOKEN, END_OF_GLOBAL_STATEMENT, PREPROCESSOR, TYPEDEF, ASSIGNMENT
	}
	...
	static public CppPart EndOfFunctionSignature(Token token2) {
	...
	public static CppPart Parameter(Token token2) {
	...
	public static CppPart Token(Token token2) {
