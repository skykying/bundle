...
public class TabDebugger extends AbstractLaunchConfigurationTab {
	...
	private static final String TAB_ID = "com.lembed.unit.test.ui.e.dsf.gdb.debuggerTab";
...
//					fTargetIpAddress.setText(DefaultPreferences.REMOTE_IP_ADDRESS_LOCALHOST);
	...
	public void initializeFrom(ILaunchConfiguration configuration) {
		...
		{
			log("TabDebugger: initializeFrom() " + configuration.getName());
		}
...
//				                                  stringDefault);
//				String physicalInterface = configuration.getAttribute(ConfigurationAttributes.GDB_SERVER_DEBUG_INTERFACE, defaultPhysicalInterface);
//
...
//
//				String defaultPhysicalInterfaceSpeed = configuration.getAttribute(ConfigurationAttributes.GDB_SERVER_SPEED_COMPAT, stringDefault);
//
//				String physicalInterfaceSpeed = configuration.getAttribute(ConfigurationAttributes.GDB_SERVER_DEVICE_SPEED, defaultPhysicalInterfaceSpeed);
//
...
//
//				fDoGdbServerInitRegs.setSelection(configuration.getAttribute(ConfigurationAttributes.DO_GDB_SERVER_INIT_REGS,
//				                                  DefaultPreferences.DO_GDB_SERVER_INIT_REGS_DEFAULT));
//
//				fDoGdbServerLocalOnly.setSelection(configuration.getAttribute(ConfigurationAttributes.DO_GDB_SERVER_LOCAL_ONLY,
...
//				fGdbServerOtherOptions.setText(configuration.getAttribute(ConfigurationAttributes.GDB_SERVER_OTHER, stringDefault));
//
//				// Allocate server console
//				fDoGdbServerAllocateConsole.setSelection(configuration.getAttribute(ConfigurationAttributes.DO_GDB_SERVER_ALLOCATE_CONSOLE,
...
//				fGdbClientOtherCommands.setText(configuration.getAttribute(ConfigurationAttributes.GDB_CLIENT_OTHER_COMMANDS, stringDefault));
//			}
//
//			// Remote Target
//			{
...
//
//		{
//			log("TabDebugger: initializeFrom() completed " + configuration.getName());
//		}
	}
	...
	public void initializeFromDefaults() {
		...
		{
			log("TabDebugger: initializeFromDefaults()");
		}
...
//		fUpdateThreadlistOnSuspend.setSelection(DefaultPreferences.UPDATE_THREAD_LIST_DEFAULT);
	...
	public void activated(ILaunchConfigurationWorkingCopy workingCopy) {
		{
			log("TabDebugger: activated() " + workingCopy.getName());
		}
	}
	...
	public void deactivated(ILaunchConfigurationWorkingCopy workingCopy) {
		{
			log("TabDebugger: deactivated() " + workingCopy.getName());
		}
	}
	...
	public void performApply(ILaunchConfigurationWorkingCopy configuration) {
		...
		{
			log("TabDebugger: performApply() " + configuration.getName() + ", dirty=" + isDirty());
		}
...
//
//		{
//			log("TabDebugger: performApply() completed " + configuration.getName() + ", dirty=" + isDirty());
//		}
	}
...
//		{
//			log("TabDebugger: setDefaults() " + configuration.getName());
//		}
//
