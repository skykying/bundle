 ...
 * @since 2.0
 */
public class CrossCDebuggerTab extends CDebuggerTab {
	 ...
	 * Bug 281970
	 */
	private final static String DEFAULTS_SET = "com.lembed.unit.test.ui.elaunch.CrossCDebuggerTab.DEFAULTS_SET"; //$NON-NLS-1$
	
    public CrossCDebuggerTab() {
