package com.lembed.unit.test.elaunch.perspective;
...
public class UnitTestPerpective implements IPerspectiveFactory {
    /** The Perspective ID */
    public static final String ID = "com.lembed.unit.test.ui.perspective"; //$NON-NLS-1$
	...
	public void createInitialLayout(IPageLayout layout) {
		...
		folder1.addView(PROJECT_VIEW_ID);
