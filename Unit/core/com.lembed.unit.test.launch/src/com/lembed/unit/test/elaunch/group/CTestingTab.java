 ...
 *******************************************************************************/
package com.lembed.unit.test.elaunch.group;
...
import com.lembed.unit.test.runner.internal.launcher.TestsRunnerProviderInfo;
...
public class CTestingTab extends CLaunchConfigurationTab {
	 ...
	 * extension point.
	 */
	private static final String TAB_ID = "com.lembed.unit.test.ui.elaunch.group.testingTab"; //$NON-NLS-1$

	private static final String TESTING_PROCESS_FACTORY_ID = "com.lembed.unit.test.ui.elaunch.TestingProcessFactory"; //$NON-NLS-1$
