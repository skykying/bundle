...
public class UnitStringsUI extends NLS {

	private static final String BUNDLE_NAME = "com.lembed.lite.studio.pack.ui.CpStringsUI"; //$NON-NLS-1$

	public static String RteMemoryFlash1;
	public static String RteMemoryFlash2;
	public static String RteMemoryExternalBase;
	public static String RteMemoryInternalBase;
	...
	public static String RteMemoryLayoutWidget_MemoryLabel;
	...
	public static String RteMemoryLayoutWizard_PageName;
	public static String RteDeviceWizard_SelectDevice;
	public static String RteMemoryLayoutPage_MemorySet;
	...
	public static String RteMemoryLayout_CoreSize;

	static {
		// initialize resource bundle
		NLS.initializeMessages(BUNDLE_NAME, UnitStringsUI.class);
	}

	private UnitStringsUI() {
	}
}
