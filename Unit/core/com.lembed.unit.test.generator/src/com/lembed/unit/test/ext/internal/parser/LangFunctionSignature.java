...
public final class LangFunctionSignature implements ILanguageUnit {
	...
	public UTestCode getCode() {
		return new UTestCode(returnType + " " + functionName + "(" + 
				join(parameters, " ") + ")");
	}
	...
	public static class SignatureBuilder {
		LangFunctionSignature signature;
		...
		private SignatureBuilder(String possibleReturnType) {
			signature = new LangFunctionSignature();
			addToFunctionDeclaration(possibleReturnType);
		}
		public LangFunctionSignature build() {
